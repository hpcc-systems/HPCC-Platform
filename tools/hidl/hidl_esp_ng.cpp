...
void HIDLcompiler::write_esp_ng()
{
    //create the *.esp file
    gOutfile = espng;
    outf("// *** Source file generated by HIDL Version %s from %s.scm ***\n", HIDLVER, packagename);
...
void HIDLcompiler::write_esp_ng_cpp()
{
    //create the *.esp file
    gOutfile = espngc;
    outf("// *** Source file generated by HIDL Version %s from %s.scm ***\n", HIDLVER, packagename);
...
{
    const char *baseclass=getParentName();
    if (!baseclass)
    {
        switch(espm_type_)
        {

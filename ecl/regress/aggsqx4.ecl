...
output(sqHousePersonBookDs, { dataset people := table(pr(aage > 20), { aage, max(group, fullname) }, aage, few) } );
...
//Filtered Aggregate on a projected table.
output(sqHousePersonBookDs, { dataset people := table(pr2(seq > 10), { surname, ave(group, aage) }, surname, few) });

...
c1(px l) := function
    ...
    children := JOIN(deduped, DG_FetchIndex1, left.LName = right.LName and left.FName = right.FName and right.__filepos != cntDedup, t2(left, right, 0));

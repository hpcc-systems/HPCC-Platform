...
// This code is convoluted (the original is worse!)
//
// This example demonstrates a problem with datasets that are used within conditional datasets
// The call to normalize is duplicated.  If the getrow() code isn't evaluated inline (see
// anshu1a.ecl) then the normalize is only generated once.

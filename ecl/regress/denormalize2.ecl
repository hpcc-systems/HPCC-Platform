...
result :=   PARALLEL(output(dataset([{'Simple Denormalize: ' + name}], {string80 _Process})),
                     ...
                     output(count(nofold(choosen(DENORMALIZE(leftinput(filters), rightinput(filters), left.value1=right.value1, makeRec(left, right, 'simple choosen')),1)))),
                     ...
                     output(count(nofold(choosen(DENORMALIZE(leftinput(filters), rightinput(filters), left.value1=right.value1, makeRecSkip(left, right, 'skip, simple choosen')),1)))),
                     ...
                     output(count(nofold(choosen(DENORMALIZE(leftinput(filters), rightinput(filters), left.value1=right.value1, makeRecCtr(left, right, counter, 'counter choosen')),1)))),
                     ...
                     output(count(nofold(choosen(DENORMALIZE(leftinput(filters), rightinput(filters), left.value1=right.value1, makeRecCtrSkip(left, right, counter, 'skip, counter choosen')),1))))
)
ENDMACRO;

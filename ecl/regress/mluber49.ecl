...
attribute_in := 'addr';
    ...
    GetAttributeItemRecord := RECORD
        STRING ModuleName{xpath('ModuleName')} := module_in;
        STRING AttributeName{xpath('AttributeName')} := attribute_in;
    END;


attrs := dataset([], GetAttributeItemRecord) : stored('attrs');

...
EXPORT personAsText2(layout.person input) := DemoD.formatHelper.formatPerson(input);&#10;
  </Attribute>
 </Module>
 ...
 <Archive package="git+ssh://git@github.com/ghalliday/gch-ecldemo-d.git#644c4585221f4dd80ca1e8f05974983455a244e5">
  <Module key="formathelper" name="formatHelper">
   <Attribute key="formatperson"
              name="formatPerson"
              sourcePath="/home/gavin/dev/demoRepoD/formatHelper/formatPerson.ecl"
              ts="1644405529000000">
    &#10;EXPORT formatPerson(input) := FUNCTIONMACRO
    //The following import needs to be resolved within this package - otherwise the child attributes will not exist

...
ds3 := nofold(DATASET([{1,'E'}, {1,'F'}, {1,'G'}], rec));
ds4 := nofold(DATASET([{1,'A'}], rec));
ds5 := nofold(DATASET([{1,'B'}], rec));
ds6 := nofold(DATASET([{1,'A'}, {1,'B'}], rec));
ds7 := nofold(DATASET([{1,'C'}, {1,'D'}, {1,'E'}], rec));
ds8 := nofold(DATASET([{1,'A'}, {1,'B'}, {1,'C'}], rec));
ds9 := nofold(DATASET([{2,'A'}], rec));
ds10 := nofold(DATASET([{0,'A'}], rec));
...
j1 := JOIN(ds1, ds2, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j4 := JOIN(ds2, ds1, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j10 := JOIN(ds1, ds5, (LEFT.i = RIGHT.i), trans(LEFT, RIGHT));
j11 := JOIN(ds1, ds5, (LEFT.i = RIGHT.i)and(LEFT.id>=RIGHT.id), trans(LEFT, RIGHT));
...
j16 := JOIN(ds1, ds5, (LEFT.i = RIGHT.i)and(LEFT.id>=RIGHT.id), trans(LEFT, RIGHT));
j17 := JOIN(ds1, ds3, LEFT.i = RIGHT.i, trans(LEFT, RIGHT), KEEP(1),left OUTER);
...
j21 := JOIN(ds7, ds1, (LEFT.i = RIGHT.i)and(LEFT.id<=RIGHT.id), trans(LEFT, RIGHT));
...
j26 := JOIN(ds1, ds1, (LEFT.i = RIGHT.i), trans(LEFT, RIGHT));
j27 := JOIN(ds1, ds8, (LEFT.i = RIGHT.i), trans(LEFT, RIGHT));
j28 := JOIN(ds7, ds1, (LEFT.i = RIGHT.i)and(LEFT.id<=RIGHT.id), trans(LEFT, RIGHT), LEFT OUTER, LOOKUP);
j29 := JOIN(ds1, ds9, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j33 := JOIN(ds1, ds9, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j36 := JOIN(ds9, ds1, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j40 := JOIN(ds9, ds1, LEFT.i = RIGHT.i, trans(LEFT, RIGHT));
...
j43 := JOIN(ds1, ds8, LEFT.i = RIGHT.i, transkip(LEFT, RIGHT));
...
j52 := JOIN(ds1, ds8, LEFT.i = RIGHT.i, transkip(LEFT, RIGHT));
...
j56 := JOIN(ds1, ds8, LEFT.i = RIGHT.i, transkip(LEFT, RIGHT));
j57 := JOIN(ds1, ds8, LEFT.i = RIGHT.i, transkip(LEFT, RIGHT), many LOOKUP, keep(sv1), local);

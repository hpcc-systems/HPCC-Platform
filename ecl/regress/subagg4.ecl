...
childSummary := table(parentDataset.children, childAggRecord(parentDataset.children))[1];

rolledupParent := table(parentDataset, { childSummary.f1, childSummary.f2, childSummary.f3, childSummary.f4  } );

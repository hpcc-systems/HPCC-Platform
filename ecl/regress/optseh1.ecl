...
output(LIMIT(DG_FetchIndex1(Lname='Anderson'),1,SKIP), {fname});
output(LIMIT(DG_FetchIndex1(Lname='Anderson'),10,SKIP), {fname});
output(LIMIT(DG_FetchIndex1(Lname='Anderson'),1,SKIP,KEYED), {fname});
output(LIMIT(DG_FetchIndex1(Lname='Anderson'),10,SKIP,KEYED), {fname});

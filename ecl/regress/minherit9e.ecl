...
options := module(options1, options2)       // ambiguous definition
        end;


options3 := module(interface1)
export boolean useName := true;
export boolean useAddress := true;
    end;

options4 := module(interface2)
export boolean useName := true;
export boolean useAvailable := false;
    end;

optionsa := module(options3, options4)      // clashing names - pure with instantiation in wrong module
        end;

...
count_inc1 := counts[1].NAge;   // Does Not Work !!
count_inc2 := counts[1].NAge+1;   // Does Not Work !!
count_inc3 := evaluate(counts[1],counts.NAge);   // Does Not Work !!
...
/* counts[1] can be omitted */
evaluate(counts[1],NAge);
evaluate(counts[1],NAge2);
evaluate(counts[1],NInc);
evaluate(counts[1],NInc2+1);

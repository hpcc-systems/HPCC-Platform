...
set flags=-P%regresstgt% -legacy -target=thorlcr -fforceGenerate -fdebugNlp=1 -fnoteRecordSizeInGraph -fregressionTest -b -m -shared -faddTimingToWorkunit=0 -fshowRecordCountInGraph -save-temps -S

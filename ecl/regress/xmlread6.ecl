...
qstring lastDate := '20049999' : stored('lastDate');
varunicode contains := U'' :stored('contains');
...
newrec  extractMatched3(newrec l) := transform
    ...
    self.description := MAP(l.description=U'Cheque Payment' and l.amount in [-24.00D,-20.00D] => U'House Cleaner',
                            ...
                            l.description=U'Cheque Payment' and ((real8)l.amount+0.0) in [-152,-212,-243,-114,-124.5,-123,-109,-452] => U'Child care',
                            l.description=U'Cheque Payment' and ((real8)l.description*1.0) in [-152,-212,-243,-114] => U'Child care',
                            l.description=U'Cheque Payment' and ((string)l.amount+'') in ['-152','-212','-243','-114','-124.5','-123','-109','-452'] => U'Child care',

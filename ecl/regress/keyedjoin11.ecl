...
//Error - rhs of keyed is not a disk file
FilledRecs := join(peopleDataset, sort(mainTable, surname), left.id=right.sequence,doJoin(left,right), KEYED(sequenceKey), limit(100));
output(FilledRecs);

...
{
public:
    FilterExtractor(IErrorReceiver & _errorReceiver, IHqlExpression * _tableExpr, int _numKeyableFields, bool isDiskRead, bool _createValueSets, bool _allKeyedFiltersOptional);

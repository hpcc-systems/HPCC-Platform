...
// ------------------------------------------------------------------------------ Dump Expression Internals

#define DUMP_CASE(t,x) case t##_##x: return #x
const char * dumpOperator(node_operator op)
{
    switch(op)
    {
    DUMP_CASE(op,band);
    ...
    DUMP_CASE(op,mul);
    DUMP_CASE(op,div);
    DUMP_CASE(op,modulus);
    DUMP_CASE(op,exp);
    DUMP_CASE(op,round);
    DUMP_CASE(op,roundup);
    DUMP_CASE(op,truncate);
    DUMP_CASE(op,power);
    DUMP_CASE(op,ln);
    DUMP_CASE(op,sin);
    DUMP_CASE(op,cos);
    ...
    DUMP_CASE(op,notin);
    DUMP_CASE(op,in);
    DUMP_CASE(op,notbetween);
    DUMP_CASE(op,between);
    DUMP_CASE(op,comma);
    DUMP_CASE(op,compound);
    DUMP_CASE(op,count);
    DUMP_CASE(op,counter);
    DUMP_CASE(op,countgroup);
    DUMP_CASE(op,distribution);
    DUMP_CASE(op,max);
    DUMP_CASE(op,min);
    DUMP_CASE(op,sum);
    DUMP_CASE(op,ave);
    DUMP_CASE(op,variance);
    DUMP_CASE(op,covariance);
    DUMP_CASE(op,correlation);
    DUMP_CASE(op,map);
    DUMP_CASE(op,if);
    DUMP_CASE(op,mapto);
    DUMP_CASE(op,constant);
    DUMP_CASE(op,field);
    DUMP_CASE(op,exists);
    DUMP_CASE(op,existsgroup);
    DUMP_CASE(op,select);
    DUMP_CASE(op,table);
    DUMP_CASE(op,temptable);
    DUMP_CASE(op,workunit_dataset);
    DUMP_CASE(op,scope);
    DUMP_CASE(op,remotescope);
    DUMP_CASE(op,mergedscope);
    DUMP_CASE(op,privatescope);
    DUMP_CASE(op,list);
    DUMP_CASE(op,selectnth);
    DUMP_CASE(op,filter);
    DUMP_CASE(op,param);
    DUMP_CASE(op,within);
    DUMP_CASE(op,notwithin);
    DUMP_CASE(op,index);
    DUMP_CASE(op,all);
    DUMP_CASE(op,left);
    DUMP_CASE(op,right);
    DUMP_CASE(op,outofline);
    DUMP_CASE(op,dedup);
    DUMP_CASE(op,enth);
    DUMP_CASE(op,sample);
    DUMP_CASE(op,sort);
    DUMP_CASE(op,shuffle);
    DUMP_CASE(op,sorted);
    DUMP_CASE(op,choosen);
    DUMP_CASE(op,choosesets);
    DUMP_CASE(op,buildindex);
    DUMP_CASE(op,output);
    DUMP_CASE(op,record);
    DUMP_CASE(op,fetch);
    DUMP_CASE(op,compound_fetch);
    DUMP_CASE(op,join);
    DUMP_CASE(op,selfjoin);
    DUMP_CASE(op,newusertable);
    DUMP_CASE(op,usertable);
    DUMP_CASE(op,aggregate);
    DUMP_CASE(op,which);
    DUMP_CASE(op,case);
    DUMP_CASE(op,choose);
    DUMP_CASE(op,rejected);
    DUMP_CASE(op,evaluate);
    DUMP_CASE(op,cast);
    DUMP_CASE(op,implicitcast);
    DUMP_CASE(op,external);
    DUMP_CASE(op,externalcall);
    DUMP_CASE(op,macro);
    DUMP_CASE(op,failure);
    DUMP_CASE(op,success);
    DUMP_CASE(op,recovery);
    DUMP_CASE(op,sql);
    DUMP_CASE(op,flat);
    DUMP_CASE(op,csv);
    DUMP_CASE(op,xml);
    DUMP_CASE(op,when);
    DUMP_CASE(op,priority);
    DUMP_CASE(op,rollup);
    DUMP_CASE(op,iterate);
    DUMP_CASE(op,assign);
    DUMP_CASE(op,asstring);
    DUMP_CASE(op,assignall);
    DUMP_CASE(op,update);
    DUMP_CASE(op,alias);
    DUMP_CASE(op,denormalize);
    DUMP_CASE(op,denormalizegroup);
    DUMP_CASE(op,normalize);
    DUMP_CASE(op,group);
    DUMP_CASE(op,grouped);
    DUMP_CASE(op,unknown);
    DUMP_CASE(op,any);
    DUMP_CASE(op,is_null);
    DUMP_CASE(op,is_valid);
    DUMP_CASE(op,abs);
    DUMP_CASE(op,substring);
    DUMP_CASE(op,newaggregate);
    DUMP_CASE(op,trim);
    DUMP_CASE(op,realformat);
    DUMP_CASE(op,intformat);
    DUMP_CASE(op,regex_find);
    DUMP_CASE(op,regex_replace);
    DUMP_CASE(op,current_date);
    DUMP_CASE(op,current_time);
    DUMP_CASE(op,current_timestamp);
    DUMP_CASE(op,cogroup);
    DUMP_CASE(op,cosort);
    DUMP_CASE(op,sortlist);
    DUMP_CASE(op,recordlist);
    DUMP_CASE(op,transformlist);
    DUMP_CASE(op,transformebcdic);
    DUMP_CASE(op,transformascii);
    DUMP_CASE(op,hqlproject);
    DUMP_CASE(op,dataset_from_transform);
    DUMP_CASE(op,newtransform);
    DUMP_CASE(op,transform);
    DUMP_CASE(op,attr);
    DUMP_CASE(op,attr_expr);
    DUMP_CASE(op,attr_link);
    DUMP_CASE(op,self);
    DUMP_CASE(op,selfref);
    DUMP_CASE(op,thor);
    DUMP_CASE(op,distribute);
    DUMP_CASE(op,distributed);
    DUMP_CASE(op,keyeddistribute);
    DUMP_CASE(op,rank);
    DUMP_CASE(op,ranked);
    DUMP_CASE(op,ordered);
    DUMP_CASE(op,hash);
    DUMP_CASE(op,hash32);
    DUMP_CASE(op,hash64);
    DUMP_CASE(op,hashmd5);
    DUMP_CASE(op,none);
    DUMP_CASE(op,notnot);
    DUMP_CASE(op,range);
    DUMP_CASE(op,rangeto);
    DUMP_CASE(op,rangefrom);
    DUMP_CASE(op,service);
    DUMP_CASE(op,mix);
    DUMP_CASE(op,funcdef);
    DUMP_CASE(op,wait);
    DUMP_CASE(op,notify);
    DUMP_CASE(op,event);
    DUMP_CASE(op,persist);
    DUMP_CASE(op,omitted);
    DUMP_CASE(op,setconditioncode);
    DUMP_CASE(op,selectfields);
    DUMP_CASE(op,quoted);
    DUMP_CASE(op,variable);
    DUMP_CASE(op,bnot);
    DUMP_CASE(op,charlen);
    DUMP_CASE(op,sizeof);
    DUMP_CASE(op,offsetof);
    DUMP_CASE(op,postinc);
    DUMP_CASE(op,postdec);
    DUMP_CASE(op,preinc);
    DUMP_CASE(op,predec);
    DUMP_CASE(op,pselect);
    DUMP_CASE(op,address);
    DUMP_CASE(op,deref);
    DUMP_CASE(op,nullptr);
    DUMP_CASE(op,decimalstack);
    DUMP_CASE(op,typetransfer);
    DUMP_CASE(op,apply);
    DUMP_CASE(op,pipe);
    DUMP_CASE(op,cloned);
    DUMP_CASE(op,cachealias);
    DUMP_CASE(op,joined);
    DUMP_CASE(op,lshift);
    DUMP_CASE(op,rshift);
    DUMP_CASE(op,colon);
    DUMP_CASE(op,global);
    DUMP_CASE(op,stored);
    DUMP_CASE(op,checkpoint);
    DUMP_CASE(op,compound_indexread);
    DUMP_CASE(op,compound_diskread);
    DUMP_CASE(op,translated);
    DUMP_CASE(op,ifblock);
    DUMP_CASE(op,crc);
    DUMP_CASE(op,random);
    DUMP_CASE(op,childdataset);
    DUMP_CASE(op,envsymbol);
    DUMP_CASE(op,null);
    DUMP_CASE(op,ensureresult);
    DUMP_CASE(op,getresult);
    DUMP_CASE(op,setresult);
    DUMP_CASE(op,extractresult);
    DUMP_CASE(op,type);
    DUMP_CASE(op,position);
    DUMP_CASE(op,bound_func);
    DUMP_CASE(op,bound_type);
    DUMP_CASE(op,hint);
    DUMP_CASE(op,metaactivity);
    DUMP_CASE(op,loadxml);
    DUMP_CASE(op,fieldmap);
    DUMP_CASE(op,template_context);
    DUMP_CASE(op,nofold);
    DUMP_CASE(op,nohoist);
    DUMP_CASE(op,fail);
    DUMP_CASE(op,filepos);
    DUMP_CASE(op,file_logicalname);
    DUMP_CASE(op,alias_project);
    DUMP_CASE(op,alias_scope);
    DUMP_CASE(op,sequential);
    DUMP_CASE(op,parallel);
    DUMP_CASE(op,actionlist);
    DUMP_CASE(op,nolink);
    DUMP_CASE(op,workflow);
    DUMP_CASE(op,workflow_action);
    DUMP_CASE(op,failcode);
    DUMP_CASE(op,failmessage);
    DUMP_CASE(op,eventname);
    DUMP_CASE(op,eventextra);
    DUMP_CASE(op,independent);
    DUMP_CASE(op,keyindex);
    DUMP_CASE(op,newkeyindex);
    DUMP_CASE(op,keyed);
    DUMP_CASE(op,split);
    DUMP_CASE(op,subgraph);
    DUMP_CASE(op,dependenton);
    DUMP_CASE(op,spill);
    DUMP_CASE(op,setmeta);
    DUMP_CASE(op,throughaggregate);
    DUMP_CASE(op,joincount);
    DUMP_CASE(op,countcompare);
    DUMP_CASE(op,limit);
    DUMP_CASE(op,fromunicode);
    DUMP_CASE(op,tounicode);
    DUMP_CASE(op,keyunicode);
    DUMP_CASE(op,parse);
    DUMP_CASE(op,newparse);
    DUMP_CASE(op,skip);
    DUMP_CASE(op,matched);
    DUMP_CASE(op,matchtext);
    DUMP_CASE(op,matchlength);
    DUMP_CASE(op,matchposition);
    DUMP_CASE(op,matchunicode);
    DUMP_CASE(op,matchrow);
    DUMP_CASE(op,matchutf8);
    DUMP_CASE(op,pat_select);
    DUMP_CASE(op,pat_index);
    DUMP_CASE(op,pat_const);
    DUMP_CASE(op,pat_pattern);
    DUMP_CASE(op,pat_follow);
    DUMP_CASE(op,pat_first);
    DUMP_CASE(op,pat_last);
    DUMP_CASE(op,pat_repeat);
    DUMP_CASE(op,pat_instance);
    DUMP_CASE(op,pat_anychar);
    DUMP_CASE(op,pat_token);
    DUMP_CASE(op,pat_imptoken);
    DUMP_CASE(op,pat_set);
    DUMP_CASE(op,pat_checkin);
    DUMP_CASE(op,pat_x_before_y);
    DUMP_CASE(op,pat_x_after_y);
    DUMP_CASE(op,pat_before_y);
    DUMP_CASE(op,pat_after_y);
    DUMP_CASE(op,pat_beginpattern);
    DUMP_CASE(op,pat_endpattern);
    DUMP_CASE(op,pat_checklength);
    DUMP_CASE(op,pat_use);
    DUMP_CASE(op,pat_validate);
    DUMP_CASE(op,topn);
    DUMP_CASE(op,outputscalar);
    DUMP_CASE(op,penalty);
    DUMP_CASE(op,rowdiff);
    DUMP_CASE(op,wuid);
    DUMP_CASE(op,featuretype);
    DUMP_CASE(op,pat_guard);
    DUMP_CASE(op,xmltext);
    DUMP_CASE(op,xmlunicode);
    DUMP_CASE(op,xmlproject);
    DUMP_CASE(op,newxmlparse);
    DUMP_CASE(op,xmlparse);
    DUMP_CASE(op,xmldecode);
    DUMP_CASE(op,xmlencode);
    DUMP_CASE(op,pat_featureparam);
    DUMP_CASE(op,pat_featureactual);
    DUMP_CASE(op,pat_featuredef);
    DUMP_CASE(op,evalonce);
    DUMP_CASE(op,distributer);
    DUMP_CASE(op,impure);
    DUMP_CASE(op,addsets);
    DUMP_CASE(op,rowvalue);
    DUMP_CASE(op,pat_case);
    DUMP_CASE(op,pat_nocase);
    DUMP_CASE(op,evaluate_stmt);
    DUMP_CASE(op,return_stmt);
    DUMP_CASE(op,activetable);
    DUMP_CASE(op,preload);
    DUMP_CASE(op,createset);
    DUMP_CASE(op,assertkeyed);
    DUMP_CASE(op,assertwild);
    DUMP_CASE(op,httpcall);
    DUMP_CASE(op,soapcall);
    DUMP_CASE(op,soapcall_ds);
    DUMP_CASE(op,newsoapcall);
    DUMP_CASE(op,newsoapcall_ds);
    DUMP_CASE(op,soapaction_ds);
    DUMP_CASE(op,newsoapaction_ds);
    DUMP_CASE(op,temprow);
    DUMP_CASE(op,projectrow);
    DUMP_CASE(op,createrow);
    DUMP_CASE(op,activerow);
    DUMP_CASE(op,newrow);
    DUMP_CASE(op,catch);
    DUMP_CASE(op,reference);
    DUMP_CASE(op,callback);
    DUMP_CASE(op,keyedlimit);
    DUMP_CASE(op,keydiff);
    DUMP_CASE(op,keypatch);
    DUMP_CASE(op,returnresult);
    DUMP_CASE(op,id2blob);
    DUMP_CASE(op,blob2id);
    DUMP_CASE(op,anon);
    DUMP_CASE(op,cppbody);
    DUMP_CASE(op,sortpartition);
    DUMP_CASE(op,define);
    DUMP_CASE(op,globalscope);
    DUMP_CASE(op,forcelocal);
    DUMP_CASE(op,typedef);
    DUMP_CASE(op,matchattr);
    DUMP_CASE(op,pat_production);
    DUMP_CASE(op,guard);
    DUMP_CASE(op,datasetfromrow);
    DUMP_CASE(op,assertconstant);
    DUMP_CASE(op,clustersize);
    DUMP_CASE(op,compound_disknormalize);
    DUMP_CASE(op,compound_diskaggregate);
    DUMP_CASE(op,compound_diskcount);
    DUMP_CASE(op,compound_diskgroupaggregate);
    DUMP_CASE(op,compound_indexnormalize);
    DUMP_CASE(op,compound_indexaggregate);
    DUMP_CASE(op,compound_indexcount);
    DUMP_CASE(op,compound_indexgroupaggregate);
    DUMP_CASE(op,compound_childread);
    DUMP_CASE(op,compound_childnormalize);
    DUMP_CASE(op,compound_childaggregate);
    DUMP_CASE(op,compound_childcount);
    DUMP_CASE(op,compound_childgroupaggregate);
    DUMP_CASE(op,compound_selectnew);
    DUMP_CASE(op,compound_inline);
    DUMP_CASE(op,setworkflow_cond);
    DUMP_CASE(op,recovering);
    DUMP_CASE(op,nothor);
    DUMP_CASE(op,call);
    DUMP_CASE(op,getgraphresult);
    DUMP_CASE(op,setgraphresult);
    DUMP_CASE(op,assert);
    DUMP_CASE(op,assert_ds);
    DUMP_CASE(op,namedactual);
    DUMP_CASE(op,combine);
    DUMP_CASE(op,combinegroup);
    DUMP_CASE(op,rows);
    DUMP_CASE(op,rollupgroup);
    DUMP_CASE(op,regroup);
    DUMP_CASE(op,inlinetable);
    DUMP_CASE(op,spillgraphresult);
    DUMP_CASE(op,enum);
    DUMP_CASE(op,pat_or);
    DUMP_CASE(op,loop);
    DUMP_CASE(op,loopbody);
    DUMP_CASE(op,cluster);
    DUMP_CASE(op,forcenolocal);
    DUMP_CASE(op,allnodes);
    DUMP_CASE(op,last_op);
    DUMP_CASE(op,pat_compound);
    DUMP_CASE(op,pat_begintoken);
    DUMP_CASE(op,pat_endtoken);
    DUMP_CASE(op,pat_begincheck);
    DUMP_CASE(op,pat_endcheckin);
    DUMP_CASE(op,pat_endchecklength);
    DUMP_CASE(op,pat_beginseparator);
    DUMP_CASE(op,pat_endseparator);
    DUMP_CASE(op,pat_separator);
    DUMP_CASE(op,pat_beginvalidate);
    DUMP_CASE(op,pat_endvalidate);
    DUMP_CASE(op,pat_dfa);
    DUMP_CASE(op,pat_singlechar);
    DUMP_CASE(op,pat_beginrecursive);
    DUMP_CASE(op,pat_endrecursive);
    DUMP_CASE(op,pat_utf8single);
    DUMP_CASE(op,pat_utf8lead);
    DUMP_CASE(op,pat_utf8follow);
    DUMP_CASE(op,sequence);
    DUMP_CASE(op,forwardscope);
    DUMP_CASE(op,virtualscope);
    DUMP_CASE(op,concretescope);
    DUMP_CASE(op,purevirtual);
    DUMP_CASE(op,internalvirtual);
    DUMP_CASE(op,delayedselect);
    DUMP_CASE(op,libraryselect);
    DUMP_CASE(op,libraryscope);
    DUMP_CASE(op,libraryscopeinstance);
    DUMP_CASE(op,libraryinput);
    DUMP_CASE(op,process);
    DUMP_CASE(op,thisnode);
    DUMP_CASE(op,graphloop);
    DUMP_CASE(op,rowset);
    DUMP_CASE(op,loopcounter);
    DUMP_CASE(op,getgraphloopresult);
    DUMP_CASE(op,setgraphloopresult);
    DUMP_CASE(op,rowsetindex);
    DUMP_CASE(op,rowsetrange);
    DUMP_CASE(op,assertstepped);
    DUMP_CASE(op,assertsorted);
    DUMP_CASE(op,assertgrouped);
    DUMP_CASE(op,assertdistributed);
    DUMP_CASE(op,datasetlist);
    DUMP_CASE(op,mergejoin);
    DUMP_CASE(op,nwayjoin);
    DUMP_CASE(op,nwaymerge);
    DUMP_CASE(op,stepped);
    DUMP_CASE(op,getgraphloopresultset);
    DUMP_CASE(op,attrname);
    DUMP_CASE(op,nonempty);
    DUMP_CASE(op,filtergroup);
    DUMP_CASE(op,rangecommon);
    DUMP_CASE(op,section);
    DUMP_CASE(op,nobody);
    DUMP_CASE(op,deserialize);
    DUMP_CASE(op,serialize);
    DUMP_CASE(op,eclcrc);
    DUMP_CASE(op,pure);
    DUMP_CASE(op,pseudods);
    DUMP_CASE(op,top);
    DUMP_CASE(op,uncommoned_comma);
    DUMP_CASE(op,nameof);
    DUMP_CASE(op,processing);
    DUMP_CASE(op,merge_pending);
    DUMP_CASE(op,merge_nomatch);
    DUMP_CASE(op,toxml);
    DUMP_CASE(op,catchds);
    DUMP_CASE(op,readspill);
    DUMP_CASE(op,writespill);
    DUMP_CASE(op,commonspill);
    DUMP_CASE(op,forcegraph);
    DUMP_CASE(op,sectioninput);
    DUMP_CASE(op,related);
    DUMP_CASE(op,definesideeffect);
    DUMP_CASE(op,executewhen);
    DUMP_CASE(op,callsideeffect);
    DUMP_CASE(op,fromxml);
    DUMP_CASE(op,preservemeta);
    DUMP_CASE(op,normalizegroup);
    DUMP_CASE(op,indirect);
    DUMP_CASE(op,selectindirect);
    DUMP_CASE(op,isomitted);
    DUMP_CASE(op,getenv);
    DUMP_CASE(op,once);
    DUMP_CASE(op,persist_check);
    DUMP_CASE(op,create_initializer);
    DUMP_CASE(op,owned_ds);
    DUMP_CASE(op,complex);
    DUMP_CASE(op,assign_addfiles);
    DUMP_CASE(op,debug_option_value);
    DUMP_CASE(op,dataset_alias);
...
const char* dumpExpressionType(type_t type)
{
    switch(type)
    {

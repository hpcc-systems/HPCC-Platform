...
extern bool verifySimplifiedDefinition(IHqlExpression *origExpr, IHqlExpression *simplifiedDefinition, const char * simplifiedEcl, const char * fullName, HqlLookupContext & ctx);

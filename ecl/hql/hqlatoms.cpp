...
IAtom * storedFieldHeightAtom;
IAtom * storedFieldSequenceAtom;
IAtom * storedFieldWidthAtom;
IAtom * streamedAtom;
...
IAtom * webserviceDescrAtom;
IAtom * webserviceFieldsAtom;
IAtom * webserviceHelpAtom;
IAtom * wholeAtom;
IAtom * widthAtom;
IAtom * wipeAtom;
...
MODULE_INIT(INIT_PRIORITY_HQLATOM)
{
    ...
    MAKEATOM(storedFieldHeight);
    MAKEATOM(storedFieldSequence);
    MAKEATOM(storedFieldWidth);
    MAKEATOM(streamed);
    ...
    MAKEATOM(warning);
    MAKEATOM(webservice);
    MAKEATOM(webserviceDescr);
    MAKEATOM(webserviceFields);
    MAKEATOM(webserviceHelp);
    MAKEATOM(whole);
    MAKEATOM(width);
    MAKEATOM(wipe);

 ...
 */
    ...
    | COS '(' startTopLeftSeqFilter ',' expression ',' simpleSortList cosOptions ')' endTopLeftFilter endSelectorSequence
                        {
                            parser->normalizeExpression($5, type_int, false);
                            NeedToMoveTransformToArg3orchangeproduction;
                            $$.setExpr(createDatasetF(no_xxxx, $3.getExpr(), $5.getExpr(), $7.getExpr(), $8.getExpr(), NULL), $1);
                        }
/*

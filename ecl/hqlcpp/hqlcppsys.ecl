...
const char * cppSystemText[]  = {
    ...
    "   unsigned4 rtlPseudoRandomNumberUniformDistribution(unsigned4 engine, unsigned4 lower_bound, unsigned4 upper_bound) : eclrtl,library='eclrtl',entrypoint='rtlPseudoRandomNumberUniformDistribution';",
    "   unsigned4 rtlPseudoRandomNumberBinomialDistribution(unsigned4 engine, real8 probability, unsigned4 upper_bound) : eclrtl,library='eclrtl',entrypoint='rtlPseudoRandomNumberBinomialDistribution';",
    "   unsigned4 rtlPseudoRandomNumberNegativeBinomialDistribution(unsigned4 engine,real8 probability, unsigned4 upper_bound) : eclrtl,library='eclrtl',entrypoint='rtlPseudoRandomNumberNegativeBinomialDistribution';",
    "   unsigned4 rtlPseudoRandomNumberGeometricDistribution(unsigned4 engine, real8 probability) : eclrtl,library='eclrtl',entrypoint='rtlPseudoRandomNumberGeometricDistribution';",
    "   unsigned4 rtlPseudoRandomNumberPoissonDistribution(unsigned4 engine,real8 mean) : eclrtl,library='eclrtl',entrypoint='rtlPseudoRandomNumberPoissonDistribution';",

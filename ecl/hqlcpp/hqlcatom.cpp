...
IIdAtom * regexStrExtractId;
IIdAtom * regexUStrExtractId;
IIdAtom * regexU8StrExtractId;
...
MODULE_INIT(INIT_PRIORITY_HQLATOM-1)
{
    ...
    MAKEID(regexStrExtract);
    MAKEID(regexUStrExtract);
    MAKEID(regexU8StrExtract);

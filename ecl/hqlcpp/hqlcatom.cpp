...
IIdAtom * rtlMinId;
IIdAtom * rtlRandomId;
IIdAtom * rtlPseudoRandomNumberUniformDistributionId;
IIdAtom * rtlPseudoRandomNumberBinomialDistributionId;
IIdAtom * rtlPseudoRandomNumberNegativeBinomialDistributionId;
IIdAtom * rtlPseudoRandomNumberGeometricDistributionId;
IIdAtom * rtlPseudoRandomNumberPoissonDistributionId;
...
MODULE_INIT(INIT_PRIORITY_HQLATOM-1)
{
    ...
    MAKEID(rtlMin);
    MAKEID(rtlRandom);
    MAKEID(rtlPseudoRandomNumberUniformDistribution);
    MAKEID(rtlPseudoRandomNumberBinomialDistribution);
    MAKEID(rtlPseudoRandomNumberNegativeBinomialDistribution);
    MAKEID(rtlPseudoRandomNumberGeometricDistribution);
    MAKEID(rtlPseudoRandomNumberPoissonDistribution);

...
namespace mongodbembed
{
    ...
    {
        VStringBuffer msg("MongoDB: type mismatch - %s expected", expected);
    ...
    public:
         ...
         * 
         * @param chars Size of the script.
         * @param eScript pointer to beginning of the script.
         */
        void setEmbed(size32_t &chars, const char *eScript) 
        {
            ...
            while((end - script) <= chars && *end != '(') end++; // Get pointer to end of the command
    ...
    protected:
        ...
        const char* cursor;                            //! Pointer for keeping track of parsing the embedded script.
    ...
    protected:
        ...
        std::shared_ptr<MongoDBQuery> query;
        int firstParam;
    ...
    public:
         ...
         */
        void executeAll(MongoDBConnection * m_oMDBConnection, unsigned &count)
        {
    ...
    class MongoDBEmbedFunctionContext : public CInterfaceOf<IEmbedFunctionContext>
    {
       ...
       protected:
           ...
           unsigned count;                                  //! Count of result rows.
           TokenDeserializer m_tokenDeserializer;
           TokenSerializer m_tokenSerializer;

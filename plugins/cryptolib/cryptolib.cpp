                                        ...
                                        size32_t lenInputdata,const void * inputdata)
{
    ...
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, nullptr, nullptr, privatekeyfile, nullptr, (const char *)passphrase, false, nullptr);
    if (pDSM)
    {
                                        ...
                                        size32_t lenInputdata,const void * inputdata)
{
    ...
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, nullptr, nullptr, privatekeyLFN, nullptr, (const char *)passphrase, true, udesc);
    if (pDSM)
    {
        doPKISign(__lenResult, __result, pDSM, lenInputdata, inputdata);
    }
...
{
    verifyPKIAlgorithm(pkalgorithm);
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, nullptr, nullptr, nullptr, privatekeybuff, (const char *)passphrase, false, nullptr);
    if (pDSM)
    {
        doPKISign(__lenResult, __result, pDSM, lenInputdata, inputdata);
    }
...
{
    verifyPKIAlgorithm(pkalgorithm);
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, publickeyfile, nullptr, nullptr, nullptr, (const char *)passphrase, false, nullptr);
    if (pDSM)
    {
                                                    ...
                                                    size32_t lenSigneddata,const void * signeddata)
{
    verifyPKIAlgorithm(pkalgorithm);
    IUserDescriptor * udesc = ctx->queryUserDescriptor();
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, publickeyLFN, nullptr, nullptr, nullptr, (const char *)passphrase, true, udesc);
    if (pDSM)
    {
        StringBuffer sbSig(lenSignature, (const char *)signature);
        bool rc = pDSM->digiVerify(sbSig.str(), lenSigneddata, signeddata);
...
{
    verifyPKIAlgorithm(pkalgorithm);
    Owned<IDigitalSignatureManager> pDSM = g_DSMCache.getInstance(pkalgorithm, nullptr, publicKeyBuff, nullptr, nullptr, (const char *)passphrase, false, nullptr);
    if (pDSM)
    {
        StringBuffer sbSig(lenSignature, (const char *)signature);
        bool rc = pDSM->digiVerify(sbSig.str(), lenSigneddata, signeddata);
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKISign(size32_t & __lenResult,void * & __result,
                                        ...
                                        size32_t lenInputdata,const void * inputdata)
{
    return clPKISign2(__lenResult,__result, pkalgorithm, privatekeyfile, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKISignLFN(ICodeContext * ctx,
                                        ...
                                        size32_t lenInputdata,const void * inputdata)
{
    return clPKISignLFN2(ctx, __lenResult,__result, pkalgorithm, privatekeyLFN, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKISignBuff(size32_t & __lenResult, void * & __result,
                                            ...
                                            size32_t lenInputdata, const void * inputdata)
{
    return clPKISignBuff2(__lenResult,__result, pkalgorithm, privatekeybuff, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API bool CRYPTOLIB_CALL clPKIVerifySignature(const char * pkalgorithm,
                                                    ...
                                                    size32_t lenSigneddata,const void * signeddata)
{
    return clPKIVerifySignature2(pkalgorithm, publickeyfile, strlen(passphrase), (const void *)passphrase, lenSignature,signature, lenSigneddata, signeddata);
}
...
CRYPTOLIB_API bool CRYPTOLIB_CALL clPKIVerifySignatureLFN(ICodeContext * ctx,
                                                    ...
                                                    size32_t lenSigneddata,const void * signeddata)
{
    return clPKIVerifySignatureLFN2(ctx, pkalgorithm, publickeyLFN, strlen(passphrase), (const void *)passphrase, lenSignature,signature, lenSigneddata, signeddata);
}
...
CRYPTOLIB_API bool CRYPTOLIB_CALL clPKIVerifySignatureBuff(const char * pkalgorithm,
                                                       ...
                                                       size32_t lenSigneddata, const void * signeddata)
{
    return clPKIVerifySignatureBuff2(pkalgorithm, publicKeyBuff, strlen(passphrase), (const void *)passphrase, lenSignature,signature, lenSigneddata, signeddata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIEncrypt(size32_t & __lenResult,void * & __result,
                                            ...
                                            size32_t lenInputdata,const void * inputdata)
{
    return clPKIEncrypt2(__lenResult, __result, pkalgorithm, publickeyfile, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIDecrypt(size32_t & __lenResult,void * & __result,
                                            ...
                                            size32_t lenEncrypteddata,const void * encrypteddata)
{
    return clPKIDecrypt2(__lenResult, __result, pkalgorithm, privatekeyfile, strlen(passphrase), (const void *)passphrase, lenEncrypteddata, encrypteddata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIEncryptLFN(ICodeContext * ctx,
                                            ...
                                            size32_t lenInputdata,const void * inputdata)
{
    return clPKIEncryptLFN2(ctx, __lenResult, __result, pkalgorithm, publickeyLFN, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIDecryptLFN(ICodeContext * ctx,
                                            ...
                                            size32_t lenEncrypteddata,const void * encrypteddata)
{
    return clPKIDecryptLFN2(ctx, __lenResult, __result, pkalgorithm, privatekeyLFN, strlen(passphrase), (const void *)passphrase, lenEncrypteddata, encrypteddata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIEncryptBuff(size32_t & __lenResult,void * & __result,
                                                ...
                                                size32_t lenInputdata,const void * inputdata)
{
    return clPKIEncryptBuff2(__lenResult, __result, pkalgorithm, publickeybuff, strlen(passphrase), (const void *)passphrase, lenInputdata, inputdata);
}
...
CRYPTOLIB_API void CRYPTOLIB_CALL clPKIDecryptBuff(size32_t & __lenResult,void * & __result,
                                                ...
                                                size32_t lenEncrypteddata,const void * encrypteddata)
{
    return clPKIDecryptBuff2(__lenResult, __result, pkalgorithm, privatekeybuff, strlen(passphrase), (const void *)passphrase, lenEncrypteddata, encrypteddata);
}

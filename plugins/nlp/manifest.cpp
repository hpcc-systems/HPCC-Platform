...
public:
    ...
    const char *stripLeadingSpecialPathCharacters(const char *input) const
    {
        //  Tidy up client side manifest paths by removing leading ".", "/", "\\" etc.
        //  This is needed to match a resource in the property tree (and not for security reasons).
    ...
    {
        const char *path = stripLeadingSpecialPathCharacters(_path);
        StringBuffer xpath;

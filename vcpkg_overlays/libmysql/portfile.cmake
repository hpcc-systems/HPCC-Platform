...
if(NOT VCPKG_TARGET_IS_WINDOWS)
    ...
    if(curses_library)
        list(APPEND curses_options
            "-DCMAKE_REQUIRED_INCLUDES=${CURRENT_INSTALLED_DIR}/include"
            "-DCURSES_NCURSES_INCLUDE_PATH=${CURRENT_INSTALLED_DIR}/include"
            "-DCURSES_INCLUDE_PATH=${CURRENT_INSTALLED_DIR}/include"
            "-DCURSES_NCURSES_LIBRARY=${curses_library}"
            "-DCURSES_LIBRARY=${curses_library}"
        )
    endif()
endif()
...
if (NOT VCPKG_TARGET_IS_WINDOWS)
    ...
    vcpkg_replace_string("${MYSQL_CONFIG_FILE}" "/bin/(mysql_[^/]*config)" "/tools/libmysql/\\1" REGEX IGNORE_UNCHANGED)
    vcpkg_replace_string("${MYSQL_CONFIG_FILE}" "'${CURRENT_PACKAGES_DIR}" "\"\$basedir\"'" IGNORE_UNCHANGED)
endif()

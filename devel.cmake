...
file(GLOB shFiles RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} cmake_modules/*.sh)
LIST(REMOVE_ITEM rFiles ${hFiles} ${dFiles} ${shFiles})
FOREACH( iFiles ${rFiles} )
    GET_FILENAME_COMPONENT(iPath "${iFiles}" PATH)
    install ( FILES ${HPCC_SOURCE_DIR}/${iFiles} DESTINATION lib/${iPath} COMPONENT Include )
ENDFOREACH()

FOREACH( iFiles ${shFiles} )
    GET_FILENAME_COMPONENT(iPath "${iFiles}" PATH)
    install ( PROGRAMS ${HPCC_SOURCE_DIR}/${iFiles} DESTINATION lib/${iPath} COMPONENT Include )
ENDFOREACH()
...
FOREACH( iFiles ${headerFiles} )
    GET_FILENAME_COMPONENT(iPath "${iFiles}" PATH)
    install ( FILES ${HPCC_SOURCE_DIR}/${iFiles} DESTINATION include/${iPath} COMPONENT Include )
ENDFOREACH()

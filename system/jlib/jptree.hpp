...
extern jlib_decl bool hasExpertOpt(const char *opt, IPropertyTree *ipt);
...
extern jlib_decl bool getExpertOptBool(const char *opt, bool dft, IPropertyTree *ipt);
extern jlib_decl __int64 getExpertOptInt64(const char *opt, __int64 dft=0);
extern jlib_decl __int64 getExpertOptInt64(const char *opt, __int64 dft, IPropertyTree *ipt);
...
extern jlib_decl void setExpertOpt(const char *opt, const char *value, IPropertyTree *ipt);

...
extern jlib_decl bool hasExpertOpt(const char *opt, IPropertyTree *ipt=nullptr);
extern jlib_decl StringBuffer &getExpertOptPath(const char *opt, StringBuffer &out);
extern jlib_decl bool getExpertOptBool(const char *opt, bool dft=false, IPropertyTree *ipt=nullptr);
extern jlib_decl __int64 getExpertOptInt64(const char *opt, __int64 dft=0, IPropertyTree *ipt=nullptr);
...
extern jlib_decl void setExpertOpt(const char *opt, const char *value, IPropertyTree *ipt=nullptr);

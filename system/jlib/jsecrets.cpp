...
static void vauleManagerConfigUpdate(const IPropertyTree *oldComponentConfiguration, const IPropertyTree *oldGlobalConfiguration)
{
...
IVaultManager *getVaultManager()
{
    ...
    if (!vaultManager)
    {
        ...
        vaultManagerUpdateHook.installOnce(vauleManagerConfigUpdate, false);
    }

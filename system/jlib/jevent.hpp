...
// More details in the cpp file before the constructor.
//
// Design goals:
...
// The implementation has been exposes used a global object so that the test for whether events are being recorded
...
bool recordingEvents() { return EventRecorderInternal::eventRecorder.isActive();}

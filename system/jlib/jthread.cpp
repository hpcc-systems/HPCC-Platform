...
class CPooledThreadWrapper: public Thread
{
    ...
    bool doNotReleaseSlotBack{false};
public:
    ...
    bool getDoNotReleaseSlotBack()
    {
        return doNotReleaseSlotBack;
    }
    void setDoNotReleaseSlotBack()
    {
        doNotReleaseSlotBack = true;
    }
...
class CThreadPool: public CThreadPoolBase, implements IThreadPool, public CInterface
{
    ...
    PooledThreadHandle _start(void *param,const char *name, bool noBlock, unsigned timeout=0)
    {
        ...
        PooledThreadHandle ret;
        {
            ...
            if (doNotReleaseSlotBack)
                t.setDoNotReleaseSlotBack();
            t.go(param);
            ret = t.queryHandle();
        }
        Sleep(0);
...
public:
    ...
    bool notifyStopped(CPooledThreadWrapper *item)
    {
        ...
        if (defaultmax) {
            ...
            if (!item->getDoNotReleaseSlotBack())
            {
                if (slotsToRelease)
                    --slotsToRelease;
                else

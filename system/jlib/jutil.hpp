...
extern jlib_decl bool checkConfigurationDirectory(const IPropertyTree* useTree, const char* category, const char* component, const char* instance, const char* dirToCheck);

...
//Deprecated: Should used Linked<X> instead
template <class CLASS> class StlLinked : public Shared<CLASS>
{
public:
    inline StlLinked() {}
    inline StlLinked(CLASS* c) : Shared<CLASS>(LINK(c)) {}
    inline StlLinked(const Shared<CLASS> & c) : Shared<CLASS>(c) {}
};

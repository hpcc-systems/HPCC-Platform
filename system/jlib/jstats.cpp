...
const StatisticsMapping stdAggregateKindStatistics({StCostFileAccess, StSizeGraphSpill, StSizeSpillFile, StCostExecute, StSizePeakTempDisk, StSizePeakEphemeralDisk});

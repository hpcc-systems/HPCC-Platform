...
extern jlib_decl IStoragePlane * getDataStoragePlane(const char * name, bool required);
extern jlib_decl IStoragePlane * getRemoteStoragePlane(const char * name, bool required);

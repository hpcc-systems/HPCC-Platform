...
public:
    ...
    CPTValue(size32_t size, const void *data) : CPTValue(size, data, false, false, COMPRESS_METHOD_NONE, COMPRESS_METHOD_NONE)
    {}
    CPTValue(size32_t size, const void *data, bool binary, bool raw, CompressionMethod currentCompressType, CompressionMethod preferredCompressType);

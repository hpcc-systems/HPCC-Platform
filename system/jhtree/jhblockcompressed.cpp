...
void CJHBlockCompressedSearchNode::load(CKeyHdr *_keyHdr, const void *rawData, offset_t _fpos, bool needCopy)
{
    ...
    CompressionMethod compressionMethod = CompressionMethod::COMPRESS_METHOD_ZSTDS;
...
CBlockCompressedWriteNode::CBlockCompressedWriteNode(offset_t _fpos, CKeyHdr *_keyHdr, bool isLeafNode, CompressionMethod _compressionMethod) : 
    CWriteNode(_fpos, _keyHdr, isLeafNode), compressionMethod(_compressionMethod)
{

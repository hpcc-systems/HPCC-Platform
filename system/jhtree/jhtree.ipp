...
protected:
    ...
    const CJHSearchNode *getNodeY(offset_t offset, NodeType type, IContextLogger *ctx) const;
    const CJHSearchNode *getNodeYY(const INodeLoader *nodeLoader, offset_t offset, NodeType type, IContextLogger *ctx) const;
...
public:
 ...
 // INodeLoader impl.
    ...
    const CJHSearchNode *getNodeZ(offset_t offset, NodeType type, IContextLogger *ctx) const
    {
        return key.getNodeYY(this, offset, type, ctx);
    }

...
interface IWritableNode
{
    ...
    virtual size32_t getMemorySize() = 0; // only valid after a write, return 0 if unknown
};
...
public:
    ...
    virtual size32_t getMemorySize() override { return 0; }
};
...
public:
    ...
    virtual size32_t getMemorySize() override { return memorySize; }
};

...
#define KEYBUILD_VERSION 3  // unsigned short. NB: This should upped if a change would make existing keys incompatible with current build.
                            // We can read indexes at versions 1, 2, 3
                            // We build indexes with version set to 1 if they are compatible with version 1 readers, otherwise 2 for inplace indexes or 3 for hybrid indexes

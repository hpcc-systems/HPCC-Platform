...
// It seems this was added to deprecate support of versions of OPENSSL that are no longer supported by the OPENSSL team
// But the code to support older versions was not removed, so disabling this here for now
// If we have issues with old versions of OPENSSL we can fix ourselves
//

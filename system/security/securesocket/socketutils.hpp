...
//
// Asyncrhonous operation uses a state machine to process connecting and writing.
...
{
    static constexpr unsigned maxQueueDepth = 10;
...
public:
    ...
    void setAsyncProcessor(IAsyncProcessor * _asyncSender) { asyncSender.setown(_asyncSender); }

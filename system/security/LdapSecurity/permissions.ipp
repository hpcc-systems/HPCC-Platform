...
#ifndef __PERMISSIONS_IPP_
#define __PERMISSIONS_IPP_
...
class CMemoryBufferWrapper;
typedef IArrayOf<CMemoryBufferWrapper> BufferArray;
...
private:
    ...
    StringBuffer         m_server_domain;
    StringBuffer         m_local_domain;

...
<xsl:template name="set.titlepage.recto">
  ...
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="setinfo/mediaobject"/>
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="info/mediaobject"/>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="set.titlepage.recto.style" text-align="left" font-size="24.8832pt" space-before="18.6624pt" font-weight="bold" font-family="{$title.fontset}">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="set.titlepage.recto.style" font-family="{$title.fontset}" text-align="left">
<xsl:apply-templates select="." mode="set.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="mediaobject" mode="set.titlepage.recto.auto.mode">
...
<xsl:template name="book.titlepage.recto">
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/mediaobject[not(@role) or @role != 'logo']"/>
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/mediaobject[not(@role) or @role != 'logo']"/>
  <xsl:choose>
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/mediaobject[@role = 'logo']"/>
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/mediaobject[@role = 'logo']"/>
</xsl:template>
...
<xsl:template name="book.titlepage.verso">
  ...
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/date"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/date"/>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" space-before="50pt">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="left" font-size="20.736pt" space-before="15.552pt" font-family="{$title.fontset}">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="corpauthor" mode="book.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" font-size="17.28pt" keep-with-next.within-column="always">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" font-size="17.28pt" space-before="10.8pt" text-align="left" keep-with-next.within-column="always">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

...
difference := MODULE
  ...
  EXPORT boolean MonitorMembers := FALSE : STORED('Compare_Members', FORMAT(sequence(11)));
  EXPORT boolean MonitorPeople := FALSE : STORED('Compare_People', FORMAT(sequence(12)));
  EXPORT boolean MonitorAddresses := FALSE : STORED('Compare_Addresses', FORMAT(sequence(13)));
  EXPORT boolean MonitorGuests := FALSE : STORED('Compare_Guests', FORMAT(sequence(14)));

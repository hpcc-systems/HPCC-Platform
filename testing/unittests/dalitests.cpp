...
public:
    ...
    void testVersion()
    {
        ...
        ASSERT(v1_0.compare(v1_3) < 0);
        ASSERT(v1_3.compare(v1_0) > 0);
        ASSERT(v1_0.compare(v3_1) < 0);
        ASSERT(v3_1.compare(v1_0) > 0);
        ASSERT(v1_3.compare(v3_1) < 0);
        ASSERT(v3_1.compare(v1_3) > 0);
        ASSERT(v1_0.compare("1.0") == 0);
        ASSERT(v1_3.compare("1.3") == 0);
        ASSERT(v1_0.compare("1.3") < 0);
        ASSERT(v1_3.compare("1.0") > 0);
        ASSERT(v1_0.compare("3.1") < 0);

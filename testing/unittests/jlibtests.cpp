...
void testDefaultMasking()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("S*************"), std::string(masked.str()).substr(0, 14));
    }
    ...
    void testLeftMasking()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("**************567890"), std::string(masked.str()));
    }
    ...
    void testCustomMaskChar()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("S#####"), std::string(masked.str()));
    }
    ...
    void testShortSecret()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("**"), std::string(masked.str()));
    }
    ...
    void testZeroPercent()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("NoM*******"), std::string(masked.str()));
    }

...
**Tip**: The `-pq` option specifies parallel query execution to utilize multiple cores on your machine, reducing execution time. The `-pq 8` option in the example specifies using 8 cores. You should use half of your available cores.

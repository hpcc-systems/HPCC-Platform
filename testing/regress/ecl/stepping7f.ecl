...
i1 := STEPPED(searchIndex(kind=1 AND word='the'), doc, PRIORITY(2),HINT(maxseeklookahead(50)));
i2 := STEPPED(searchIndex(kind=1 AND word='walls'), doc, PRIORITY(3),HINT(maxseeklookahead(50)));

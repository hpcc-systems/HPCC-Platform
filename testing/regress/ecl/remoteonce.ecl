...
index_best := SORT(LIMIT(Files.DG_FetchIndex1(LName[1]=onceFilterSet),1000000), LName, FName);
...
disk_best := SORT(Files.DG_FetchFile(LName[1]=onceFilterSet), LName, FName);
...
preload_best := sort(Files.DG_FetchFilePreload(LName[1]=onceFilterSet), LName, FName);
...
preload_indexed_best := SORT(Files.DG_FetchFilePreloadIndexed(KEYED(LName[1]=onceFilterSet)), LName, FName);

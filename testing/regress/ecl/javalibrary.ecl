...
//nohthor
//nothor
//The library is defined and built in aaajavalibrary.ecl
...
filterDataset(dataset(namesRecord) ds, string search, boolean onlyOldies) := library('aaaJavaLibrary',FilterDatasetInterface(ds,empty,search,onlyOldies),hint(required(true)));

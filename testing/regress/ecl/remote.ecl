...
index_best := SORT(LIMIT(Files.DG_FetchIndex1(LName[1]='A'),1000000), LName, FName);
...
disk_best := SORT(Files.DG_FetchFile(LName[1]='A'), LName, FName);
...
preload_best := sort(Files.DG_FetchFilePreload(LName[1]='A'), LName, FName);
...
preload_indexed_best := SORT(Files.DG_FetchFilePreloadIndexed(KEYED(LName[1]='A')), LName, FName);

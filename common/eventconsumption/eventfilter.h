...
extern event_decl IEventFilter* createEventFilter(CMetaInfoState& metaState);
extern event_decl IEventFilter* createEventFilter(const IPropertyTree& config, CMetaInfoState& metaState);
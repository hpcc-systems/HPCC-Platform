...
interface IConstWUResult : extends IInterface
{
    ...
    virtual void getResultFieldFormat(unsigned &width, unsigned &height, unsigned &sequence) const = 0;
};
...
interface IWUResult : extends IConstWUResult
{
    ...
    virtual void setResultFieldFormat(unsigned fieldWidth, unsigned fieldHeight, unsigned fieldSeq)=0;
};

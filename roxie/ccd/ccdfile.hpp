...
{
    virtual ILazyFileIO *lookupFile(const char *lfn, RoxieFileType fileType, IPartDescriptor *pdesc, IPartDescriptor *remotePDesc, unsigned numParts,
                                      unsigned channel, bool startFileCopy) = 0;

...
class EventRecordingSummary;
extern bool startRoxieEventRecording(const char * optionsText, const char * filename);
extern bool stopRoxieEventRecording(EventRecordingSummary * optSummary);

========================================================================
                    CUSTOM APPWIZARD: esp_simple_client
========================================================================


AppWizard has created a esp_simple_client DLL for you.  This DLL is the starting point
...
you build esp_simple_client.awx, it will automatically be copied to your Template
...
make up your esp_simple_client DLL.

esp_simple_client.dsw
...
esp_simple_client.dsp
    This file (the project file) contains information at the project level and
    is used to build a single project or subproject. Other users can share the
    project (.dsp) file, but they should export the makefiles locally.

esp_simple_client.opt
...
esp_simple_clientAw.h, esp_simple_clientAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CEsp_simple_clientAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into esp_simple_client.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "E:\devn\esp\clients\wswulib\wswulib.dsp".
...
off of the project "E:\devn\esp\clients\wswulib\wswulib.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named esp_simple_client.pch and a precompiled types file named StdAfx.obj.

========================================================================
                    CUSTOM APPWIZARD: esp_service_wizard
========================================================================


AppWizard has created a esp_service_wizard DLL for you.  This DLL is the starting point
...
you build esp_service_wizard.awx, it will automatically be copied to your Template
...
make up your esp_service_wizard DLL.

esp_service_wizard.dsw
...
esp_service_wizard.dsp
    This file (the project file) contains information at the project level and
    is used to build a single project or subproject. Other users can share the
    project (.dsp) file, but they should export the makefiles locally.

esp_service_wizard.opt
...
esp_service_wizardAw.h, esp_service_wizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CEsp_service_wizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into esp_service_wizard.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "E:\devn\esp\services\HeaderFileSearch\HeaderFileSearch.dsp".
...
off of the project "E:\devn\esp\services\HeaderFileSearch\HeaderFileSearch.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named esp_service_wizard.pch and a precompiled types file named StdAfx.obj.

...
import { Checkbox, Table, TableHeader, TableRow, TableHeaderCell, TableBody, TableCell, Button, Menu, MenuTrigger, MenuPopover, MenuList, MenuItem, Spinner, makeStyles, mergeClasses, tokens } from "@fluentui/react-components";
import { FolderRegular, DocumentRegular, ServerRegular, DesktopRegular, ChevronDownRegular, ChevronRightRegular, MoreHorizontalRegular } from "@fluentui/react-icons";
...
interface LandingZoneTreeTableProps {
    ...
    onItemAction?: (item: LandingZoneItem, action: string) => void;
}
...
export const LandingZoneTreeTable: React.FunctionComponent<LandingZoneTreeTableProps> = ({
    ...
    const handleResizeMouseDown = (columnId: keyof typeof columnWidths) => (evt: React.MouseEvent) => {
    ...
    const handleExpansionToggle = (item: LandingZoneItem) => {
    ...
    const handleSelectionToggle = (item: LandingZoneItem) => {
    ...
    const handleRowClick = (item: LandingZoneItem, evt: React.MouseEvent) => {
            ...
            <Table className={styles.table} size="small">
                <TableHeader className={styles.tableHeader}>
                    <TableRow>
                        ...
                        <TableHeaderCell className={mergeClasses(styles.resizableHeaderCell, styles.tableCell)} style={{ width: `${columnWidths.actions}px` }}>
                            {""}
                        </TableHeaderCell>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {items.map((item) => (
                        ...
                        >
                            ...
                            <TableCell className={styles.tableCell} style={{ width: `${columnWidths.actions}px` }}>
                                {item.type === "file" ? (
                                    <Menu>
                                        ...
                                        <MenuPopover>
                                            <MenuList>
                                                <MenuItem onClick={() => onItemAction?.(item, "download")}>
                                                    {nlsHPCC.Download}
                                                </MenuItem>
                                                <MenuItem onClick={() => onItemAction?.(item, "delete")}>
                                                    {nlsHPCC.Delete}
                                                </MenuItem>
                                            </MenuList>
                                        </MenuPopover>

...
export type FieldType = "string" | "number" | "checkbox" | "datetime" | "dropdown" | "link" | "links" |
    "workunit-state" |
...
type Field = StringField | NumericField | CheckboxField | DateTimeField | DropdownField | LinkField | LinksField |
    WorkunitStateField |

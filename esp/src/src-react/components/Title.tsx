...
export const DevTitle: React.FunctionComponent<DevTitleProps> = ({
    ...
    const advMenuProps = React.useMemo(() => {
        return {
            items: [
                { key: "banner", text: nlsHPCC.SetBanner, disabled: currentUser.username !== null || !isAdmin, onClick: () => setShowBannerConfig(true) },
                { key: "toolbar", text: nlsHPCC.SetToolbar, disabled: currentUser.username !== null || !isAdmin, onClick: () => setShowTitlebarConfig(true) },

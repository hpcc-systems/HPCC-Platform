...
export const Xrefs: React.FunctionComponent<XrefsProps> = ({
    ...
    const buttons = React.useMemo((): ICommandBarItemProps[] => [
        ...
        {
            key: "generate", text: nlsHPCC.Generate, disabled: !uiState.hasSelection,
    ...
    ], [filterScopes, handleFilterScopesChange, opsCategory, refreshData, selection, setShowCancelConfirm, setShowGenerateConfirm, uiState]);

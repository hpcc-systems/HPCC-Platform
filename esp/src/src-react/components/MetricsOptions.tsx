...
import { DockPanelLayout } from "src-react/layouts/DockPanel";
        ...
        <MessageBox title={nlsHPCC.Options} show={show && !showAdd} setShow={setShow} minWidth={width}
            ...
            <>
                <Stack horizontal>
                    ...
                    <Button appearance="subtle" icon={<DeleteRegular />} title={nlsHPCC.Delete} disabled onClick={() => {
                    }} />
                </Stack>
                <Pivot>
                            ...
                            <Stack horizontal>
                                <Stack.Item grow={1}>
                                    <GridOptions
                                        ...
                                        setSelection={scopeTypes => dirtyView.scopeTypes = scopeTypes}
                                    ></GridOptions>
                                </Stack.Item>
                                <Stack.Item grow={1}>
                                    <GridOptions
                                        ...
                                        setSelection={properties => dirtyView.properties = properties}
                                    ></GridOptions>
                                </Stack.Item>
                            </Stack>
                        </div>

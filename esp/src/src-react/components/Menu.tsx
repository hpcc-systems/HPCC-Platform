...
const subMenuItems: SubMenuItems = {
    ...
    "operations": [
        { headerText: nlsHPCC.Topology, itemKey: "/operations/topology" },
        { headerText: nlsHPCC.TargetClusters, itemKey: "/operations/clusters" },
        { headerText: nlsHPCC.ClusterProcesses, itemKey: "/operations/processes" },
        { headerText: nlsHPCC.SystemServers, itemKey: "/operations/servers" },

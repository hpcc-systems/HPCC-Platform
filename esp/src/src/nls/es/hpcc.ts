export = {
    ...
    AbortSelectedWorkunits: "¿Cancelar unidad(es) de trabajo seleccionada(s)? Su ID de inicio de sesión se registrará para esta acción dentro de la(s) WU(s).",
    About: "Acerca",
    ...
    Account: "Cuenta",
    AccountDisabled: "Cuenta deshabilitada. Póngase en contacto con el administrador del sistema.",
    Action: "Acción",
    Activate: "Activar",
    Activated: "Activado",
    ...
    AllowFull: "Permitir Completo",
    AllowRead: "Permitir Leer",
    AllowWrite: "Permitir Escribir",
    AllQueries: "Todas las consultas",
    ...
    Apply: "Aplicar",
    Apps: "Aplicaciones",
    ArchiveDFUWorkunit: "Archivar unidad de trabajo DFU",
    ...
    ArchiveECLWorkunit: "Archivar unidad de trabajo ECL",
    ...
    Back: "Atras",
    BackupDFUWorkunit: "Respaldar unidad de trabajo DFU",
    BackupECLWorkunit: "Respaldar unidad de trabajo ECL",
    BannerColor: "Color de Banner",
    BannerColorTooltip: "Cambiar el color del fondo de la barra de navegación superior",
    BannerMessage: "Mensaje del Banner",
    BannerMessageTooltip: 'Cambiar el título mostrado en la barra de navegación superior (predeterminado "ECL Watch")',
    ...
    ColumnMode: "Modo de Columna",
    Columns: "Columnas",
    Command: "Comando",
    Comment: "Comentario",
    Compilation: "Compilacion",
    CompileCost: "Costo de compilación",
    Compiled: "Compilado",
    ...
    CookiesNoticeLinkText: "Nuestro aviso de cookies",
    Copied: "Copiado",
    Copy: "Copia",
    ...
    CSV: "CSV",
    CustomLogColumns: "Columnas de Registro Personalizado",
    Dali: "Dali",
    DaliAdmin: "Administrador de Dalí",
    DaliIP: "IP de Dali",
    DaliPromptConfirm: "¿Está seguro? Las sumisiones de Dali Admin son permanentes y no se pueden deshacer.",
    Dashboard: "Tablero",
    Data: "Datos",
    DataPatterns: "Patrones de datos",
    DataPatternsDefnNotFound: "Definición de archivo no encontrada. Los patrones de datos no se pueden iniciar.",
    ...
    DenyAccess: "Negar Access",
    DenyFull: "Negar Completo",
    DenyRead: "Negar Leer",
    DenyWrite: "Negar Escribir",
    Depth: "Profundidad",
    ...
    DownloadToCSVNonFlatWarning: "Tenga en cuenta: la descarga de archivos que contienen conjuntos de datos anidados como datos separados por comas puede no tener el formato esperado",
    DownloadToDOT: "Descargar a DOT",
    ...
    Exception: "Excepción",
    ExcludeIndexes: "Excluir Indices",
    ExecuteCost: "Costo de ejecución",
    Executed: "Ejecutado",
    ...
    FieldNames: "Campo de nombres",
    File: "Archivo",
    FileAccessCost: "Costo de acceso a archivos",
    FileCluster: "Racimo de archivos",
    FileCostAtRest: "Costo de archivo en reposo",
    ...
    FilePermissionError: "Error al obtener permisos de archivo",
    Files: "Archivos",
    ...
    Filter: "Filtro",
    FilterDetails: "Detalles del filtro",
    ...
    Generate: "Generar",
    GetDFSCSV: "CSV de DFS",
    GetDFSMap: "Mapa DFS",
    GetDFSParents: "Padres de DFS",
    GetLastServerMessage: "Obtener último mensaje del servidor",
    GetLogicalFile: "Archivo lógico",
    GetLogicalFilePart: "Parte del archivo lógico",
    ...
    Icon: "Icono",
    ID: "ID",
    IFrameErrorMsg: "No se pudo cargar el marco, inténtelo de nuevo.",
    IgnoreGlobalStoreOutEdges: "Ignorar los bordes de salida de el almacén global",
    Import: "Importar",
    Inactive: "Inactivo",
    IncludePerComponentLogs: "Incluir registros por componente",
    IncludeRelatedLogs: "Incluir registros relacionados",
    IncludeSlaveLogs: "Incluir slave logs",
    IncludeSubFileInfo: "¿Incluir información de subarchivo?",
    Index: "Indice",
    Indexes: "Índices",
    IndexesOnly: "Solo índices",
    Info: "información",
    ...
    LatestReleases: "Últimas versiones",
    Layout: "Diseño",
    ...
    Log: "Registro",
    LogAccessType: "Tipo de acceso al registro",
    LogDirectory: "Directorio de logs",
    LogEventType: "Tipo de Evento de Registro",
    LogFile: "Archivo de registro",
    LogFilterComponentsFilterTooltip: "Incluir solo registros del componente/contenedor seleccionado",
    LogFilterCustomColumnsTooltip: "Incluir las columnas de registro especificadas",
    LogFilterEndDateTooltip: "Incluir solo entradas hasta el final del rango de tiempo especificado",
    LogFilterEventTypeTooltip: "Incluir solo entradas para el tipo de evento de registro especificado",
    LogFilterFormatTooltip: "Formato de archivo de registro: CSV, JSON o XML",
    LogFilterLineLimitTooltip: "El número de líneas de registro que se incluirán",
    LogFilterLineStartFromTooltip: "Incluir líneas de registro a partir de este número de línea",
    LogFilterRelativeTimeRangeTooltip: "Un rango de tiempo que rodea el tiempo de la WU, +/- (en segundos)",
    LogFilters: "Filtros de Registro",
    LogFilterSelectColumnModeTooltip: "Especificar qué columnas incluir en el archivo de registro",
    LogFilterSortByTooltip: "ASC - el más antiguo primero, DESC - el más nuevo primero",
    LogFilterStartDateTooltip: "Incluir líneas de registro a partir del inicio del rango de tiempo especificado",
    LogFilterTimeRequired: 'Elija entre "Desde y Hasta la Fecha" o "Búfer de Tiempo Relativo de Registro"',
    LogFilterWildcardFilterTooltip: "Una cadena de texto sobre la cual filtrar los mensajes de registro",
    ...
    LogicalNameMask: "Máscara de nombre lógico",
    Login: "Iniciar sesión",
    LogLineLimit: "Límite de Líneas de Registro",
    LogLineStartFrom: "Inicio de Línea de Registro Desde",
    ...
    Mask: "Máscara",
    Max: "Máx",
    MaxConnections: "Máximas conexiones",
    ...
    NA: "No Applica",
    Name: "Nombre",
    NameOfEnvironment: "Nombre informático",
    ...
    NextWorkunit: "Siguiente unidad de trabajo",
    NoCommon: "No hay común",
    NoContent: "(No hay contenido)",
    NoContentPleaseSelectItem: "Sin contenido, por favor seleccione un elemento",
    ...
    NoRecentFiltersFound: "No se encontraron filtros recientes",
    Normal: "Normal",
    ...
    Platform: "Plataforma",
    PlatformBuildIsNNNDaysOld: "La construcción de la plataforma tiene NN días de antigüedad",
    ...
    PleaseUpgradeToLaterPointRelease: "Por favor, actualice a una versión posterior",
    Plugins: "Complementos",
    PodName: "Nombre del pod",
    Pods: "Pods",
    PodsAccessError: "No se puede recuperar la lista de pods",
    Port: "Puerto",
    ...
    PreserveParts: "Preservar Partes del Archivo",
    PressCtrlCToCopy: "Oprima ctrl+c para copiar",
    Preview: "Presentación Preliminar",
    PreviousSelection: "Selección anterior",
    PreviousWorkunit: "Unidad de trabajo anterior",
    ...
    RecentFilters: "Filtros recientes",
    RecentFiltersTable: "Tabla de filtros recientes",
    ...
    RedBook: "Red Book",
    Refresh: "Actualizar",
    RelativeLogTimeRange: "Rango de Tiempo de Registro Relativo",
    ...
    RemoteStorage: "Almacenamiento remoto",
    Remove: "Remover",
    ...
    Restarts: "Reinicios",
    Restore: "Restaurar",
    RestoreDFUWorkunit: "Restaurar unidad de trabajo DFU",
    RestoreECLWorkunit: "Restaurar unidad de trabajo ECL",
    ...
    RetainSuperfileStructureReason: "Retener estructura del super-archivo",
    ...
    Security: "Seguridad",
    SecurityMessageHTML: "Solo vea HTML de usuarios de confianza. Esta unidad de trabajo fue creada por '{__placeholder__}'. ¿Representar HTML?",
    ...
    SetLogicalFileAttribute: "Establecer Atributo de Archivo Lógico",
    SetProtected: "Establecer como Protegido",
    ...
    SetToolbar: "Barra de herramientas definido",
    SetToolbarColor: "Establecer el color de la barra de herramientas",
    SetUnprotected: "Establecer como No Protegido",
    ...
    ShowSVG: "Mostrar SVG",
    Size: "Tamaño",
    SizeEstimateInMemory: "Estimación de tamaño en la memoria",
    ...
    SuspendedByAnyNode: "Suspendida por cualquier nodo",
    SuspendedByCluster: "Suspendida  por el Clúster",
    SuspendedByFirstNode: "Suspendida por primer nodo",
    SuspendedByUser: "Suspendida por el Usuario",
    ...
    ThreadID: "Identificación de subproceso",
    Time: "Tiempo",
    Timeline: "Cronología",
    ...
    TimePenalty: "Penalización de tiempo",
    Timers: "Cronómetros",
    ...
    ToTime: "Tiempo de Terminar",
    TransferRate: "Tasa de Transferencia",
    TransferRateAvg: "Tasa de Transferencia (Promedio)",
    ...
    Who: "Quien",
    Width: "Ancho",
    WildcardFilter: "Filtro de Comodín",
    Workflows: "Flujos de Trabajo",
    Workunit: "Unidad de trabajo",
    WorkunitNotFound: "Unidad de trabajo no encontrada",

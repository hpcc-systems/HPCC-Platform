export = {
    ...
    DaliAdmin: "Dali 管理",
    DaliExport: "Dali 输出",
    DaliExportConfirm: "您确定要导出Dali文件系统吗？",
    DaliExportPathConfirm: "您的路径\"/\"太宽，导出可能需要很长时间。您确定要继续吗？",
    DaliIP: "Dali IP",
    ...
    EBCDIC: "EBCDIC",
    ECL: "ECL",
    ECLLayoutNotAvailable: "ECL布局不适合此文件",
    ...
    EraseHistory: "删除历史",
    EraseHistoryQ: "删除相关历史:",
    Error: "错误",
    ErrorAbortingUpload: "错误上传",
    ErrorLoadingConfigurationFile: "加载配置文件时出错",
    ...
    EventText: "事件内容",
    EventTextPH: "事件文字",
    ExampleScopePlaceholder: "示例预留作用域",
    Exception: "异常",
    ExcludeIndexes: "排出指数",
    ExecuteCost: "运行成本",
    Executed: "已执行",
    ...
    Last: "最后的",
    LastAccessed: "上次进入",
    LastAccessedLocalTime: "最后访问（当地时间）",
    LastEdit: "最新编辑",
    LastEditedBy: "最新编辑者",
    LastEditTime: "最新编辑时间",
    LastMessage: "最后一条信息",
    ...
    Links: "联接",
    List: "列表",
    ListDFUWorkunit: "列表DFU Workunit",
    ListECLWorkunit: "列出ECL Workunit",
    Loading: "加载",
    ...
    Mine: "本人所有",
    Minimize: "最小化",
    MinimumCompileCost: "最低编译成本",
    MinimumExecuteCost: "最低执行成本",
    MinimumFileAccessCost: "最低文件访问成本",
    MinNode: "最小节点",
    Minor: "次要的",
    MinSize: "最小规格",
    MinSkew: "最小偏差",
    ...
    More: "更多",
    Move: "移动",
    MoveBottomHint: "移动底部（ctrl+单击点）",
    MoveDown: "向下移动",
    MoveDownHint: "向下移动（CTRL+单击移至底部）",
    MoveUp: "向上移动",
    MoveUpHint: "向上移动（CTRL+单击移动到顶部）",
    ...
    NoRemoteStorageFound: "未找到远程存储。",
    Normal: "正常",
    NoScheduledEvents: "无计划事件",
    NoSplit: "不分割",
    NotActive: "没有激活",
    NotAvailable: "不可获得",
    ...
    PerformingLayoutFailed: "Layout失败选择其他⬆Root⬆",
    PerformingLayoutLongRunning: "⏳执行布局不耐烦？",
    Permission: "权限",
    PermissionName: "权限名",
    Permissions: "使用权限",
    PhysicalFiles: "物理文件",
    ...
    Recycling: "再循环",
    RedBook: "红皮书",
    RedirectedByPickBestEngine: "（由pickBestEngine重定向）",
    RedirectedTo: "重定向到",
    Refresh: "更新",
    RelativeLogTimeRange: "相对日志时间范围",
    ...
    ReplicateTooltip: "在spray完成后，复制会异步进行",
    Report: "报告",
    ...
    SelectValue: "选择一个值",
    SelectWorkunitToRestore: "请选择一个或多个工作单元以恢复。",
    SendEmail: "发送电子邮件",
    Separators: "分割符",
    Sequence: "序列",
    Server: "服务器",
    ...
    StorageStateParseFailure: "无法解析存储的状态",
    StorageStateWriteFailure: "写入数据存储失败",
    Subfiles: "子文件",
    Subgraph: "子图",
    SubgraphLabel: "子图标识",
    Subgraphs: "子图",
    ...
    SVGSource: "SVG原始数据",
    SwitchToLocalTime: "切换到当地时间",
    SwitchToUTCTime: "切换到UTC时间",
    SyncSelection: "选择同步",
    Syntax: "语法",
    SystemServers: "系统服务器",
    Table: "表",
    ...
    Tree: "树",
    Type: "类型",
    UnableToRetrieveGroups: "无法检索您的小组会员资格",
    UnavailableInBareMetal: "在非容器化环境中不可用",
    UnavailableInContainerized: "在容器化环境中不可用",
    Unbound: "解除捆绑",
    undefined: "未定义",
    UnexpectedProcessTermination: "意外的进程终止",
    Unknown: "未知",
    Unlock: "解锁",
    ...
    WorkunitSummarySplitter: "Workunit摘要分离器",
    Wrap: "自动换行",
    WSDL: "WSDL",
    WUErrorsWarnings: "错误/警告",
    WUID: "工作单元标识",

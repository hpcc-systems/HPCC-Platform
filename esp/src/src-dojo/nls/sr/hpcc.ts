export = {
    ...
    ActivitiesPreview: "Активности (п)",
    Activity: "Активност",
    ...
    LogFilterTimeRequired: "Изаберите или „Од и до датума“ или „Релативни временски бафер евиденције“",
    ...
    PerformingLayoutFailed: "Лаиоут Фаилед Изаберите другачијег ⬆рооте",
    PerformingLayoutLongRunning: "≥Перформисање лажног материјала нестрпљиво?",
    Permission: "Дозвола",

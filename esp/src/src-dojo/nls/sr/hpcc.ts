export = {
    ...
    CancelUploadConfirm: "Отказати тренутне отпремање?",
    CannotDisplayBinaryData: "Није могуће приказати бинарне податке",
    Category: "Категорија",
    CausedBy: "Узрокован",
    Channel: "Канал",
    Chart: "дијаграм",
    ...
    DaliExport: "Дали Извоз",
    DaliExportConfirm: "Јесте ли сигурни да желите да извозите Дали систем датотека?",
    DaliExportPathConfirm: "Ваша путања \" / \“ је широка и извоз може потрајати дуго. Да ли сте сигурни да желите да наставите?",
    ...
    DeselectAll: "Опозови избор свега",
    ...
    EBCDIC: "ЕБЦДИK",
    ECL: "ЕЦЛ",
    ECLLayoutNotAvailable: "ЕЦЛ изглед није доступан за ову датотеку",
    ...
    Error: "Грешка",
    ErrorAbortingUpload: "Грешка приликом прекида отпрема",
    ErrorLoadingConfigurationFile: "Грешка при учитавању конфигурационе датотеке",
    ...
    ExampleScopePlaceholder: "Филтрирај по опсегу нпр. scope1::scope2",
    ...
    FetchingErrorDetails: "Појединости о грешкама",
    ...
    FileDoesNotExist: "Датотека не постоји",
    FileExists: "Датотека постоји",
    ...
    GlobalMetrics: "Глобална метрика",
    Graph: "Граф",
    ...
    LastAccessedLocalTime: "Последњи приступ (локално време)",
    ...
    Links: "Линкови",
    List: "Листа",
    ListDFUWorkunit: "Листа ДФУ ВоркуРит",
    ListECLWorkunit: "Листа ЕЦЛ Воркунит",
    Loading: "Учитавање...",
    ...
    LogFiltersUnavailable: "Филтери дневника нису доступни",
    ...
    MachineNotFoundFor: "Машина није пронађена",
    Machines: "Машине",
    Major: "Главни",
    ManagedBy: "Управљан",
    ...
    Mine: "Moj",
    Minimize: "Умањити",
    MinimumCompileCost: "Минимални трошкови састављања",
    MinimumExecuteCost: "Минимални трошкови извршења",
    MinimumFileAccessCost: "Минимални трошкови приступа датотекама",
    ...
    ModifiedLocalTime: "Модификовано (локално време)",
    ...
    More: "Наставите",
    Move: "Помери",
    MoveBottomHint: "Померите дно (Цтрл + Цлицк-Довн)",
    MoveDown: "Померити се",
    MoveDownHint: "Помицање доле (Цтрл + кликни корак на дну)",
    MoveUp: "Померити се",
    MoveUpHint: "Помицање горе (Цтрл + Цлицк Мове на врх)",
    ...
    NavWide: "Навигацијски широк режим",
    ...
    NoRemoteStorageFound: "Није пронађено удаљено складиштење.",
    Normal: "Нормалан",
    ...
    PerformingLayout: "Извршава распоред...",
    PerformingLayoutFailed: "Неуспешно извршавање распореда. Изаберите други корен.",
    PerformingLayoutLongRunning: "Извршавање распореда може потрајати...",
    Permission: "Дозвола",
    ...
    RedirectedByPickBestEngine: "(преусмерено од стране pickBestEngine)",
    RedirectedTo: "Преусмерено на",
    Refresh: "Освежите",
    ...
    ReplicateTooltip: "Репликација се одвија асинхроно након завршетка spray-а",
    Report: "Извештај",
    ...
    SelectA: "Изаберите",
    SelectAZAPFile: "Изаберите ЗАП датотеку за увоз.",
    SelectAll: "Изабери све",
    SelectAnOption: "Изаберите опцију",
    SelectDateRange: "Изаберите Датум домета",
    Selected: "Изабрано",
    SelectEllipsis: "Изабери ...",
    SelectPackageFile: "Изаберитe Пакет",
    SelectValue: "Изаберите вредност",
    SelectWorkunitToRestore: "Молимо одаберите једну или више радних минута да бисте се вратили.",
    ...
    StorageStateParseFailure: "Рашчлањивање сачуваног стања није успело",
    StorageStateWriteFailure: "Писање података за складиштење није успело",
    Subfiles: "Подфајлови",
    Subgraph: "ПодГраф",
    ...
    SVGSource: "СВГ Извор",
    SwitchToLocalTime: "Пређите на локално време",
    SwitchToUTCTime: "Пребаците се на време УТЦ",
    ...
    Tree: "Дрво",
    Type: "Тип",
    UnableToRetrieveGroups: "Није могуће преузети чланство у групи",
    UnavailableInBareMetal: "Ово није доступно у неконтеињеризованом окружењу.",
    UnavailableInContainerized: "Ово није доступно у контејнерском окружењу.",
    Unbound: "невезан",
    undefined: "недефинисан",
    UnexpectedProcessTermination: "неочекивано прекидање процеса",
    Unknown: "Непознат",
    Unlock: "Откључај",
    ...
    Upload: "Aплоyд",
    UploadCancelled: "Отклапање отказано",
    UploadComplete: "Отпремање завршено",
    Uploading: "Учитавање",
    UpTime: "Време Радa",
    URL: "УРЛ",
    Usage: "Употреба",
    ...
    WorkunitSummarySplitter: "Резиме сажетка у радним путем",
    Wrap: "Замотајте",
    WSDL: "WSDL",
    WUErrorsWarnings: "Грешке/Упозорења",
    WUID: "PJИД",

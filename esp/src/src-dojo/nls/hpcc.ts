export = {
    root: {
        ...
        PlaceholderFindText: "Search pages, workunits, files and more...",
        SearchForPagesWorkunitFilesQueries: "Search for pages, workunits, files, queries...",
        PressEnterToOpen: "Press ↵ to open \"{0}\" or Ctrl+↵ to search all",
        PressEnterToSearchAll: "Press ↵ to search all categories",
        ...
        WorkunitSummary: "Workunit Summary",

export = {
    ...
    ActivitiesLegacy: "Actividades (L)",
    Activity: "Actividad",
    ...
    BannerMessageTooltip: "Cambie el título que se muestra en la navegación superior (valor predeterminado: ECL Watch)",
    ...
    CancelUploadConfirm: "¿Cancelar la carga actual?",
    CannotDisplayBinaryData: "No se puede mostrar datos binarios.",
    Category: "Categoría",
    ...
    CopyOpenTelemetry: "Copiar OpenTelemetry",
    ...
    DaliExport: "Exportar Dali",
    DaliExportConfirm: "¿Seguro que desea exportar el sistema de archivos Dali? Los archivos pueden ser grandes y su exportación puede tardar bastante.",
    DaliExportPathConfirm: "Su ruta \" / \" es amplia y podría tardar bastante en exportarse. ¿Está seguro de que desea continuar?",
    DaliIP: "IP de Dali",
    ...
    EBCDIC: "EBCDIC",
    ECL: "ECL",
    ECLLayoutNotAvailable: "El diseño de ECL no está disponible para este archivo",
    ...
    ECLWatchVersion: "Versión de ECL Watch",
    ...
    Error: "Error",
    ErrorAbortingUpload: "Error al abortar la carga",
    ErrorLoadingConfigurationFile: "Error al cargar el archivo de configuración",
    ...
    ExampleScopePlaceholder: "Filtrar por ámbito p.ej. scope1::scope2",
    Exception: "Excepción",
    ...
    FetchingErrorDetails: "Detalles del error de obtención",
    ...
    FileSummaries: "Resúmenes de archivos",
    ...
    FilterMetricsTooltip: "Esto filtrará según la columna 'Ámbito' de forma predeterminada. Para filtrar basado en cualquier otra columna, use el nombre de la columna como prefijo en su búsqueda, por ejemplo: 'NombreArchivo:spill'",
    ...
    Grid: "Cuadrícula",
    GridAbortMessage: "Cancelando solicitud obsoleta de la cuadrícula",
    Group: "Grupo",
    GroupBy: "Ordenar Por",
    ...
    Import: "Importar",
    Inactive: "Inactivo",
    IncludePendingItems: "Incluir elementos pendientes",
    ...
    LastAccessedLocalTime: "Último acceso (hora local)",
    ...
    Links: "Vínculos",
    List: "Lista",
    ListDFUWorkunit: "Lista de DFU WorkUnit",
    ...
    LogAccess_GenericException: "ws_logaccess::GetLogAccessInfo, ha ocurrido una excepción.",
    LogAccess_LoggingNotConfigured: "No se ha configurado LogAccess.",
    ...
    LogFiltersUnavailable: "Los filtros de registro no están disponibles",
    LogFilterTimeRequired: "Seleccione 'Fecha de inicio y de fin' o 'Búfer de tiempo de registro relativo'",
    ...
    Logs: "Registros",
    LogsDisabled: "Registros deshabilitados",
    ...
    MachineNotFoundFor: "Máquina no encontrada para",
    Machines: "Máquinas",
    Major: "Mayor",
    ...
    MatchWholeWord: "Coincidir con la palabra entera",
    Max: "Máx",
    ...
    Methods: "Métodos",
    MetricOptions: "Opciones de métricas",
    Metrics: "Métrica",
    ...
    Mine: "Mío",
    Minimize: "Minimizar",
    MinimumCompileCost: "Costo de compilación mínima",
    MinimumExecuteCost: "Costo de ejecución mínima",
    MinimumFileAccessCost: "Costo de acceso mínimo a los archivos",
    MinNode: "Nodo mínimo",
    Minor: "Menor",
    ...
    Modified: "modificado",
    ModifiedLocalTime: "Modificado (hora local)",
    ...
    More: "Mas",
    Move: "Mover",
    MoveBottomHint: "Mover hacia abajo (ctrl+clic hacia abajo)",
    MoveDown: "Mover hacia abajo",
    MoveDownHint: "Mover hacia abajo (ctrl+clic para mover hacia abajo)",
    MoveUp: "Subir",
    MoveUpHint: "Mover hacia arriba (ctrl+clic en mover hacia arriba)",
    ...
    NavWide: "Modo de navegación amplio",
    ...
    NoRemoteStorageFound: "No se encontró almacenamiento remoto.",
    Normal: "Normal",
    ...
    PasswordNeverExpires: "La contraseña nunca expira",
    ...
    PerformingLayoutFailed: "Fallo de diseño. Elija una raíz diferente.",
    PerformingLayoutLongRunning: "¿Impacientes al realizar el diseño? Elige una raíz diferente.",
    Permission: "Permiso",
    ...
    RedBook: "Red Book",
    RedirectedByPickBestEngine: "(redirigido por pickBestEngine)",
    RedirectedTo: "Redirigido a",
    Refresh: "Actualizar",
    RelativeLogTimeRange: "Rango de Tiempo de Registro Relativo",
    RelativeTimeRange: "Rango de tiempo relativo",
    ...
    ReplicateTooltip: "La replicación ocurre de forma asíncrona después de que se completa el spray",
    Report: "Reporte",
    ...
    ResetUserSettings: "Restablecer configuración de usuario",
    ...
    SaveAs: "Guardar como",
    Scope: "Ámbito",
    ScopeColumns: "Columnas de ámbito",
    ScopeTypes: "Tipos de ámbito",
    ...
    SelectAZAPFile: "Seleccione un archivo ZAP para importar.",
    SelectAll: "Seleccionar todo",
    SelectAnOption: "Seleccione una opción",
    SelectDateRange: "Rango de fechas de selección",
    Selected: "Seleccionado",
    SelectEllipsis: "Seleccione...",
    SelectPackageFile: "Seleccione &lsquo;Package File&rsquo;",
    SelectValue: "Seleccione un valor",
    SelectWorkunitToRestore: "Seleccione una o más Workunits para restaurar.",
    ...
    StorageStateParseFailure: "No se pudo analizar el estado almacenado",
    StorageStateWriteFailure: "Error al escribir datos para almacenar",
    ...
    SwitchToLocalTime: "Cambiar a la hora local",
    SwitchToUTCTime: "Cambiar a la hora de UTC",
    Sync: "Sincronizar",
    ...
    Tree: "Arbol",
    Type: "Tipo",
    UnableToRetrieveGroups: "No se pueden recuperar las membresías de su grupo",
    UnavailableInBareMetal: "Esto no está disponible en un entorno sin contenedores.",
    UnavailableInContainerized: "Esto no está disponible en un entorno contenedor.",
    Unbound: "No esta consolidado",
    undefined: "no definido",
    UnexpectedProcessTermination: "terminación inesperada del proceso",
    Unknown: "Desconocido",
    Unlock: "Abrir",
    ...
    Upload: "Subir",
    UploadCancelled: "Cargue cancelado",

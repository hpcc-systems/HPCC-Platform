export = {
    ...
    AddResource: "Erőforrás hozzáadása",
    ...
    Apply: "Alkalmaz",
    Apps: "Applikáció",
    ArchiveDFUWorkunit: "DFU-munkaegység archiválás",
    ...
    ArchiveECLWorkunit: "ECL-munkaegység archiválás",
    ...
    Back: "Vissza",
    BackupDFUWorkunit: "DFU-munkaegység biztonsági mentése",
    BackupECLWorkunit: "ECL-munkaegység biztonsági mentése",
    ...
    ColorTokens: "Szín tokenek",
    ColumnMode: "Oszlop mód",
    Columns: "Oszlopok",
    Command: "Parancs",
    Comment: "Megjegyzés",
    ...
    CompressionType: "Tömörítés típusa",
    ...
    ConnectionID: "Kapcsolat azonosítója",
    ...
    CopyOpenTelemetry: "Open Telemetry másolása",
    ...
    DownloadToDOT: "Letöltés a DOT-ba",
    DropZone: "Gyűjtőhely",
    ...
    Error: "Hiba",
    ErrorAbortingUpload: "Hiba a feltöltés megszakításában",
    ErrorLoadingConfigurationFile: "Hiba a konfigurációs fájl betöltésekor",
    ...
    ExampleScopePlaceholder: "Szűrés hatókör szerint pl. scope1::scope2",
    Exception: "Kivétel",
    ...
    FilterMetricsTooltip: "'Ez alapértelmezés szerint a „Scope” oszlop alapján szűr. Bármely más oszlop alapján történő szűréshez használja az oszlop nevét a keresés előtagjaként, pl: „Filename:spill”",
    ...
    GetLastServerMessage: "Utolsó szerver üzenet lekérése",
    ...
    GetValue: "Értéke",
    GetVersion: "Verzió lekérése",
    GlobalMetrics: "Globális mérőszámok",
    Graph: "Gráf",
    GraphControl: "Graph Control",
    Graphs: "Gráfok",
    GraphView: "Gráf nézet",
    Grid: "Rács",
    GridAbortMessage: "Grid megszakítja az elavult kérést",
    Group: "Csoport",
    ...
    Import: "Import",
    Inactive: "Inaktív",
    IncludePendingItems: "Függő tételek felvétele",
    IncludePerComponentLogs: "Komponensenkénti naplók felvétele",
    IncludeRelatedLogs: "Tartalmazza a kapcsolódó naplókat",
    ...
    LatestReleases: "Legfrissebb kiadások",
    Layout: "Elrendezés",
    ...
    Links: "Linkek",
    List: "Lista",
    ListDFUWorkunit: "Sorolja fel a DFU munkaegységét",
    ...
    LogEventType: "Eseménynapló bejegyzés típus",
    LogFile: "Log fájl",
    LogFilterComponentsFilterTooltip: "Csak a kiválasztott komponenshez/konténerhez tartozó eseménynapló bejegyzések",
    LogFilterCustomColumnsTooltip: "A megadott eseménynapló oszlopok bevonása",
    LogFilterEndDateTooltip: "Naplósorok felvétele az időtartomány végéig",
    LogFilterEventTypeTooltip: "Csak a kiválasztott tipusú eseménynapló bejegyzések",
    ...
    LogFilterRelativeTimeRangeTooltip: "A wu idő körüli időtartomány, +/- (másodpercben)",
    ...
    LogicalGraph: "Logikai grafikon",
    LogicalName: "Logikai név",
    LogicalNameMask: "Logikai fájl maszk",
    Login: "Bejelentkezés",
    LogLineLimit: "Eseménynapló méret korlátozás",
    LogLineStartFrom: "Eseménynapló-sorok kezdete",
    Logout: "Kijelentkezés",
    Logs: "Logok",
    LogsDisabled: "Naplózás letiltva",
    ...
    Methods: "Eljárások",
    MetricOptions: "Metrikus beállítások",
    Metrics: "Metrika",
    ...
    NextWorkunit: "Következő munkaegység",
    NoCommon: "Nem közös",
    NoContent: "(Nincs tartalom)",
    NoContentPleaseSelectItem: "Nincs tartalom - válaszon ki egy elemet",
    ...
    NoRemoteStorageFound: "Nem található távoli tárhely.",
    Normal: "Normál",
    ...
    PasswordNeverExpires: "A jelszó soha nem jár le",
    ...
    PerformingLayoutFailed: "Elrendezés sikertelen. Válasszon egy másik kiindulási pontot.",
    PerformingLayoutLongRunning: "Elrendezés folyamatban... Kis türelmet kérünk.",
    ...
    Platform: "Platform",
    PlatformBuildIsNNNDaysOld: "Ez a Platform verzió NNN napja készült.",
    ...
    PleaseUpgradeToLaterPointRelease: "Kérjük, frissítsen egy újabb kiadásra.",
    Plugins: "Betölthető modulok",
    PodName: "POD neve",
    Pods: "Pod-ok",
    PodsAccessError: "A POD-ok listája nem elérhető",
    Port: "Port",
    PotentialSavings: "Potenciális megtakarítás",
    Prefix: "Előtag",
    ...
    PreviousWorkunit: "Előző munkaegység",
    ...
    RedirectedByPickBestEngine: "(átirányítva a pickBestEngine által)",
    RedirectedTo: "Átirányítva ide",
    Refresh: "Frissítés",
    RelativeLogTimeRange: "Relatív eseménynaplózási időtartomány",
    RelativeTimeRange: "Relatív időtartomány",
    ...
    ReplicateTooltip: "A replikáció aszinkron módon történik a spray befejezése után",
    Report: "Jelentés",
    ...
    ResetUserSettings: "Felhasználói beállítások visszaállítása",
    ...
    RestoreDFUWorkunit: "DFU-munkaegyság visszaállítása",
    RestoreECLWorkunit: "ECL-munkaegység visszaállítása",
    ...
    Scope: "Hatókör",
    ScopeColumns: "Hatókör oszlopai",
    ScopeTypes: "Hatókör típusok",
    ...
    SelectAZAPFile: "Válasszon egy ZAP fájlt az importáláshoz.",
    ...
    SetLogicalFileAttribute: "Logikai fájl attribútum beállítása",
    SetProtected: "Védett beállítás",
    ...
    StorageStateParseFailure: "A tárolt állapot elemzése nem sikerült",
    StorageStateWriteFailure: "Az adatok tárolása nem sikerült",
    Subfiles: "Alfájlok",
    Subgraph: "Al-gráf",
    ...
    SwitchToUTCTime: "Váltás az UTC időre",
    Sync: "Szinkronizálás",
    ...
    ToTime: "Időre",
    Trace: "Nyomkövetés",
    TransferRate: "Átviteli sebesség",
    TransferRateAvg: "Átviteli sebesség (átlagos)",
    ...
    UnexpectedProcessTermination: "váratlan folyamatleállítás",
    Unknown: "Ismeretlen",
    Unlock: "Feloldott",
    ...
    UploadComplete: "Feltöltés befejezve",
    Uploading: "Feltöltés",
    ...
    Who: "Ki?",
    Width: "Szélesség",
    WildcardFilter: "Wildcard szűrő",
    Workflows: "Munkafolyamat",
    Workunit: "Feladat",
    WorkunitNotFound: "Munkaegység nem található",
    ...
    Wrap: "Csomagol (Wrap)",
    WSDL: "WSDL",
    WUErrorsWarnings: "Hibák/Figyelmeztetések",
    WUID: "WUID",

export = {
    ...
    EBCDIC: "EBCDIC",
    ECL: "ECL",
    ECLLayoutNotAvailable: "ECL izgled nije dostupan za ovu datoteku",
    ...
    PerformingLayoutFailed: "LAYOUT nije uspio - Odaberite drugačiji ⬆Root⬆",
    PerformingLayoutLongRunning: "⏳Port -performans Layout⏳ Nestrpljiv?",
    Permission: "Dozvola",

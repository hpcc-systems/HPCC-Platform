export = {
    ...
    CancelUploadConfirm: "Otkazati trenutni prijenos?",
    CannotDisplayBinaryData: "Nemoguće prikazati binarne podatke.",
    Category: "Kategorija",
    CausedBy: "Uzrokovan",
    Channel: "Kanal",
    Chart: "Grafikon",
    ...
    CompressionType: "Vrsta kompresije",
    ...
    DaliExport: "Dali Izvoz",
    DaliExportConfirm: "Jeste li sigurni da želite izvesti Dali datotečni sustav?",
    DaliExportPathConfirm: "Vaš put \" / \" je širok i izvoz može potrajati dugo. Jeste li sigurni da želite nastaviti?",
    ...
    EBCDIC: "EBCDIC",
    ECL: "ECL",
    ECLLayoutNotAvailable: "ECL format nije dostupan za ovu datoteku",
    ...
    Error: "Greška",
    ErrorAbortingUpload: "Pogreška prekida prijenos",
    ErrorLoadingConfigurationFile: "Pogreška pri učitavanju konfiguracijske datoteke",
    ...
    ExampleScopePlaceholder: "Filtriraj po opsegu npr. scope1::scope2",
    ...
    FetchingErrorDetails: "Pojedinosti o pogrešci dohvaćanja",
    ...
    GlobalMetrics: "Globalna metrika",
    Graph: "Graf",
    ...
    Inputs: "Unosi",
    InstanceNumber: "Broj instancije",
    InUse: "U uporabi",
    ...
    LastAccessedLocalTime: "Posljednji pristup (lokalno vrijeme)",
    ...
    Links: "Linkovi",
    List: "Lista",
    ListDFUWorkunit: "Popis DFU WorkUnit",
    ListECLWorkunit: "Popis ECL WorkUnit",
    Loading: "Učitavanje...",
    ...
    MachineNotFoundFor: "Stroj nije pronađen za",
    Machines: "Mašine",
    Major: "Glavni",
    ManagedBy: "Upravljan",
    ...
    MatchWholeWord: "Podudarati cijelu riječ",
    Max: "Maksimum",
    ...
    Mine: "Moj",
    Minimize: "Umanjiti",
    MinimumCompileCost: "Minimalni trošak sastavljanja",
    MinimumExecuteCost: "Minimalni trošak izvršenja",
    MinimumFileAccessCost: "Minimalni trošak pristupa datoteci",
    ...
    ModifiedLocalTime: "Izmijenjeno (lokalno vrijeme)",
    ...
    More: "Nastavite",
    Move: "Premjestite",
    MoveBottomHint: "Pomaknite dno (Ctrl+klik-dolje)",
    MoveDown: "Pomaknuti se prema dolje",
    MoveDownHint: "Pomaknite se prema dolje (ctrl+kliknite Premjesti na dno)",
    MoveUp: "Pomaknuti se prema gore",
    MoveUpHint: "Pomaknite se prema gore (Ctrl+Kliknite Premjesti na vrh)",
    ...
    NavWide: "Navigacijski široki način rada",
    ...
    NoRemoteStorageFound: "Nije pronađen udaljeni prostor za pohranu.",
    Normal: "Normalan",
    ...
    PerformingLayoutFailed: "Neuspješno izvođenje rasporeda. Odaberite drugi korijen",
    PerformingLayoutLongRunning: "Izvođenje rasporeda moglo bi potrajati...",
    Permission: "Dozvola",
    ...
    RedirectedByPickBestEngine: "(preusmjereno od strane pickBestEngine)",
    ...
    ReplicateTooltip: "Replikacija se odvija asinkrono nakon završetka spray-a",
    Report: "Izvješće",
    ...
    SelectA: "Odaberite",
    SelectAZAPFile: "Odaberite ZAP datoteku za uvoz.",
    SelectAll: "Odaberi sve",
    SelectAnOption: "Odaberite opciju",
    SelectDateRange: "Odaberite datumski raspon",
    Selected: "Odabran",
    SelectEllipsis: "Odaberite ...",
    SelectPackageFile: "Izaberi Paket",
    SelectValue: "Odaberite vrijednost",
    SelectWorkunitToRestore: "Odaberite jednu ili više WorkUnits -a za obnovu.",
    ...
    StorageStateParseFailure: "Raščlanjivanje pohranjenog stanja nije uspjelo",
    StorageStateWriteFailure: "Zapisivanje podataka za pohranu nije uspjelo",
    ...
    SVGSource: "SVG Izvor",
    SwitchToLocalTime: "Prebacite se na lokalno vrijeme",
    SwitchToUTCTime: "Prebacite se na vrijeme UTC",
    ...
    Tree: "Drvo",
    Type: "Tip",
    UnableToRetrieveGroups: "Nije moguće dohvatiti članstvo u grupi",
    UnavailableInBareMetal: "Ovo nije dostupno u okruženju bez kontejnera.",
    UnavailableInContainerized: "Ovo nije dostupno u kontejnerskom okruženju.",
    Unbound: "Odvojen",
    undefined: "nedefinisan",
    UnexpectedProcessTermination: "neočekivani prekid procesa",
    Unknown: "Nepoznat",
    Unlock: "Otključajte",
    ...
    Upload: "Učitajte",
    UploadCancelled: "Upload otkazan",
    UploadComplete: "Prijenos završen",
    ...
    Wrap: "Zamotajte",
    WSDL: "WSDL",
    WUErrorsWarnings: "Greške/Upozorenja",
    WUID: "WUID",

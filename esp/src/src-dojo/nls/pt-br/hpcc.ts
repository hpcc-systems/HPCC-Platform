export = {
    ...
    Add: "Adicionar",
    AddAttributes: "Adiciona atributos/valores para seu método",
    AddAttributes2: "Adiciona atributos",
    AddBinding: "Adiciona conexão",
    Added: "Adicionado",
    ...
    Apply: "Aplicar",
    Apps: "Apps",
    ArchiveDFUWorkunit: "Arquivar WU DFU",
    ...
    ArchiveECLWorkunit: "Arquivar WU ECL",
    ...
    CopyOpenTelemetry: "Copiar Open Telemetry",
    ...
    DaliExportPathConfirm: "Seu caminho de arquivo \" / \" é abrangente e pode levar muito tempo para exportar. Tem certeza de que deseja continuar?",
    DaliIP: "IP do Dali",
    ...
    ExampleScopePlaceholder: "Escopo temporário de exemplo",
    Exception: "Exceção",
    ...
    FetchingErrorDetails: "Buscando detalhes do erro",
    ...
    FilterMetricsTooltip: "Por padrão, a filtragem será feita com base na coluna \"Escopo\". Para filtrar por qualquer outra coluna, use o nome da coluna como prefixo para sua pesquisa, por exemplo: \"Nome do arquivo:spill\"",
    ...
    GetLastServerMessage: "Obtenha a última mensagem do servidor",
    ...
    GlobalMetrics: "Métricas Globais",
    Graph: "Grafo",
    GraphControl: "Controle Gráfico",
    Graphs: "Gráficos",
    GraphView: "Visão Gráfica",
    Grid: "Grade",
    GridAbortMessage: "Grid abortando requisição obsoleta",
    Group: "Grupo",
    ...
    Import: "Importar",
    Inactive: "Inativo",
    IncludePendingItems: "Incluindo itens pendentes",
    IncludePerComponentLogs: "Incluir logs por componente",
    IncludeRelatedLogs: "Incluir logs relacionados",
    ...
    Loading: "Carregando",
    LoadingCachedLayout: "Carregando layout do cache",
    ...
    LogFiltersUnavailable: "Filtros de Logs não estão disponíveis",
    ...
    Logs: "Registros",
    LogsDisabled: "Logs Desabilitados",
    ...
    MaximumNumberOfSlaves: "Número máximo de escravos",
    MaxNode: "Nó Max",
    MaxRecordLength: "Máximo tamanho do registro",
    ...
    NextWorkunit: "Próxima WU",
    NoCommon: "Incomum",
    NoContent: "(sem conteúdo)",
    NoContentPleaseSelectItem: "Sem conteúdo - selecione um item",
    ...
    NoRemoteStorageFound: "Nenhum armazenamento remoto encontrado.",
    Normal: "Normal",
    ...
    PasswordNeverExpires: "Senha nunca expira",
    ...
    Platform: "Plataforma",
    PlatformBuildIsNNNDaysOld: "A construção da plataforma tem NNN dias.",
    ...
    PleaseUpgradeToLaterPointRelease: "Por favor, atualize para uma versão posterior.",
    Plugins: "Plugins",
    PodName: "Nome do pod",
    Pods: "Pods",
    ...
    QueryNamePlaceholder: "Nome provisório da consulta",
    ...
    RemoteStorage: "Armazenamento remoto",
    Remove: "Remover",
    ...
    ReplicateTooltip: "Sugestão para replicar",
    Report: "Relatório",
    ...
    Restarts: "Reinicia",
    Restore: "Restaurar",
    RestoreDFUWorkunit: "Restaurar WU DFU",
    RestoreECLWorkunit: "Restaurar WU ECL",
    Restricted: "Restrito",
    Resubmit: "Resubmeter",
    Resubmitted: "Submeter de novo",
    ResubmitTooltip: "Submeter WU de novo",
    Results: "Resultado(s)",
    Resume: "Continue",
    ...
    SaveAs: "Salvar Como",
    Scope: "Escopo",
    ScopeColumns: "Colunas de Escopo",
    ScopeTypes: "Tipos de Escopo",
    ...
    SelectAZAPFile: "Selecione um arquivo ZAP para importar.",
    ...
    StorageStateParseFailure: "Falha ao analisar estado de armazenamento",
    StorageStateWriteFailure: "Falha ao gravar estado de armazenamento",
    ...
    TimePenalty: "Penalidade de tempo",
    ...
    UnexpectedProcessTermination: "encerramento inesperado do processo",
    Unknown: "Desconhecido",
    Unlock: "Desbloquear",
    UnlockSDSLock: "Desabilitar SDS Lock",
    Unprotect: "Desprotege",
    UnprotectAll: "Desproteger tudo",
    UnprotectAllConfirm: "Tem certeza de que deseja remover todas as proteções deste arquivo?",
    ...
    UpdateSuperFiles: "Atualizar superfile",
    Upload: "Enviar",
    ...
    Workunits: "Tarefas",
    WorkUnitScopeDefaultPermissions: "Permissões de escopo padrão para workunit",
    WorkunitSummarySplitter: "Divisor de sumário da workunit",
    Wrap: "Embrulho",
    WSDL: "WSDL",
    WUErrorsWarnings: "Erros/Avisos",
    WUID: "WUID",
    Wuidcannotbeempty: "Wuid não pode estar vazia",
    WUSnapShot: "Snapshot de WU",
    WUSnapshot: "Snapshot WU",
    WUSnapshots: "Snapshots da WU",
    WUSummary: "Resumo",
    XGMML: "XGMML",
    XLS: "XLS",
    XML: "XML",

export = {
    ...
    PerformingLayoutFailed: "Layout nije uspio odabrati drugačiju ⬆root⬆",
    PerformingLayoutLongRunning: "Nestrpljivi pri izvođenju rasporeda? Odaberite drugi korijen",
    Permission: "Dozvola",

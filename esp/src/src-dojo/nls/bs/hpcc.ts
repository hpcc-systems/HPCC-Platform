export = {
    ...
    CancelUploadConfirm: "Otkažite trenutni prenos?",
    CannotDisplayBinaryData: "Ne mogu prikazati binarne podatke.",
    Category: "Kategorija",
    CausedBy: "Uzrokovano",
    Channel: "Kanal",
    Chart: "Grafikon",
    ...
    DaliExport: "Izvoz Dali-ja",
    DaliExportConfirm: "Jeste li sigurni da želite izvesti Dali datotečni sistem?",
    DaliExportPathConfirm: "Vaš naziv odredišta je kompleksan i izvoz može potrajati dugo. Jeste li sigurni da želite nastaviti?",
    ...
    EBCDIC: "EBCDIC",
    ECL: "ECL",
    ECLLayoutNotAvailable: "ECL struktura za ovu datoteku nije dostupna",
    ...
    Error: "Greška",
    ErrorAbortingUpload: "Pogreška prilikom prekida u učitavanju",
    ErrorLoadingConfigurationFile: "Greška pri učitavanju konfiguracijske datoteke",
    ...
    FetchingErrorDetails: "Dohvaćanje podataka o grešci",
    ...
    FilterMetricsTooltip: "Ovo će se filtrirati na osnovu kolone \"Scope\" prema zadanim postavkama. Za filtriranje na osnovu bilo koje druge kolone, koristite naziv kolone kao prefiks pretrage, npr.: \"Naziv datoteke: spill\"",
    ...
    LastAccessedLocalTime: "Zadnji pristup (lokalno vrijeme)",
    ...
    Links: "Linkovi",
    List: "Lista",
    ListDFUWorkunit: "List DFU Workounit",
    ListECLWorkunit: "List ECL Workounit",
    Loading: "Učitavanje...",
    ...
    MachineNotFoundFor: "Mašina nije pronađena za",
    Machines: "Mašine",
    Major: "Glavni",
    ManagedBy: "Upravljan",
    ...
    MatchWholeWord: "Uskladite cijelu riječ",
    Max: "Maksimum",
    ...
    MinimumCompileCost: "Minimalni trošakovi kompiliranja",
    MinimumExecuteCost: "Minimalni troškovi izvršenja",
    MinimumFileAccessCost: "Cijena minimalnog pristupa datoteci",
    ...
    ModifiedLocalTime: "Modifikovano (lokalno vrijeme)",
    ...
    More: "Nastavite",
    Move: "Premjestite",
    MoveBottomHint: "Pomicanje dna (Ctrl + kliknu)",
    MoveDown: "Pomaknuti se",
    MoveDownHint: "Pomaknite dolje (Ctrl + kliknite se na dolje)",
    MoveUp: "Pomaknuti se",
    MoveUpHint: "Pomicanje gore (Ctrl + kliknite Pomaknite se na vrh)",
    ...
    NavWide: "Navigacija široki režim",
    ...
    PerformingLayoutFailed: "Izvršavanje nije uspjelo. Odaberite drugi početak",
    PerformingLayoutLongRunning: "Izvršavanje bi moglo potrajati...",
    Permission: "Dozvola",
    ...
    ReplicateTooltip: "Replikacija se odvija asinhrono nakon završetka spray-a",
    Report: "Izvještaj",
    ...
    SelectWorkunitToRestore: "Molimo odaberite jednu ili više radnih jedinica za obnovu.",
    ...
    StorageStateParseFailure: "Nije uspjelo raščlanjivanje pohranjenog stanja",
    StorageStateWriteFailure: "Zapisivanje podataka u pohranu nije uspjelo",
    Subfiles: "Podfajlovi",
    Subgraph: "Pod-Graf",
    ...
    SwitchToUTCTime: "Prebacite se na UTC vrijeme",
    ...
    Tree: "Drvo",
    Type: "Tip",
    UnableToRetrieveGroups: "Ne može preuzeti članstvo u vašoj grupi",
    UnavailableInBareMetal: "Ovo nije dostupno u okruženju koje nije kontejnerizirano.",
    ...
    Upload: "Učitajte",
    UploadCancelled: "Učitavanje otkazano",
    ...
    WorkunitSummarySplitter: "Razdjelnik sažetka radnih jedinica",
    Wrap: "Zamotajte",
    WSDL: "WSDL",

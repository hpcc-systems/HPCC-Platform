...
define([
    ...
    "dijit/TooltipDialog"
                ...
                selector,
                _TabContainerWidget, ESPUtil, ESPWorkunit, DelayLoadWidget, TargetSelectWidget, FilterDropDownWidget, ECLSourceWidget, WsTopology,
                template) {
    return declare("LogWidget", [_TabContainerWidget, ESPUtil.FormHelper], {
        ...
        refreshGrid: function (clearSelection) {
            ...
            /*
            Name://192.168.1.201/var/log/HPCCSystems/myeclccserver/eclccserver.log
            Type:tpcomp_log
            Reversely:false
            HasDate:1
            FilterType:4

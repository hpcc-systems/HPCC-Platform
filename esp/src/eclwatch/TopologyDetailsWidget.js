...
define([
    ...
    return declare("TopologyDetailsWidget", [_TabContainerWidget], {
        ...
        init: function (params) {
            ...
            if (this.params.__hpcc_treeItem.OS && this.params.__hpcc_treeItem.Netaddress && (this.params.__hpcc_treeItem.LogDirectory || this.params.__hpcc_parentNode.__hpcc_treeItem.LogDirectory)) {

...
{
    Owned<IDistributedFile> dst = queryDistributedFileDirectory().lookup(logicalname, userdesc, AccessMode::readLogicalMeta, false, false, nullptr, defaultPrivilegedUser);
    if (dst)
    {

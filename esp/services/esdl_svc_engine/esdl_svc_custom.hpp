...
{
       virtual void processTransform(IEspContext * context, IEsdlDefMethod &mthdef, StringBuffer & request, IPropertyTree * bindingCfg)=0;
};
...
public:
    ...
    void processTransform(IEspContext * context, IEsdlDefMethod &mthdef, StringBuffer & request, IPropertyTree * bindingCfg);
};

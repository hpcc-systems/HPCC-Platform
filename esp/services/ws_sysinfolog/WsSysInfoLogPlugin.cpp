...
{
    if (strieq(type, "ws_sysinfolog"))
    {
        Cws_sysinfologEx* service = new Cws_sysinfologEx;
...
ESP_FACTORY IEspRpcBinding * esp_binding_factory(const char *name, const char* type, IPropertyTree *cfg, const char *process)
{
    ...
    if (strieq(type, "ws_sysinfologSoapBinding")||strieq(type, "ws_sysinfolog_http"))
    {
#ifdef _DEBUG
...
#endif
        return new Cws_sysinfologSoapBinding(cfg, name, process, log_level_);
    }

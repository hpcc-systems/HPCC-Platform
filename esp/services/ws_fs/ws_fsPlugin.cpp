...
{
    if (strieq(type, "FileSpray")||strieq(type, "FileSpray_Serv"))
    {
        CFileSprayEx* service = new CFileSprayEx;
...
ESP_FACTORY IEspRpcBinding * esp_binding_factory(const char *name, const char* type, IPropertyTree *cfg, const char *process)
{
    ...
    if (strieq(type, "FileSpray_Bind")||strieq(type, "filespray_http")||strieq(type, "filespray_serv_http"))
    {
#ifdef _DEBUG
...
#endif
        return new CFileSpraySoapBindingEx(cfg, name, process, log_level_);
    }

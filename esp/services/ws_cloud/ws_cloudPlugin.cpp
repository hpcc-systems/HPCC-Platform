...
{
    if (strieq(type, "WsCloud"))
    {
        CWsCloudEx* service = new CWsCloudEx;
...
ESP_FACTORY IEspRpcBinding * esp_binding_factory(const char *name, const char* type, IPropertyTree *cfg, const char *process)
{
    ...
    if (strieq(type, "ws_cloudSoapBinding")||strieq(type, "wscloud_http"))
    {
        return new CWsCloudSoapBinding(cfg, name, process);
    }

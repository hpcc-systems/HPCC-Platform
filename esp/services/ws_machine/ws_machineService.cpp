...
void handleGetGlobalMetrics(IEspGetGlobalMetricsRequest &req, IEspGetGlobalMetricsResponse &resp)
{
    ...
    CDateTime start, end;
    start.setString(req.getDateTimeRange().getStart(), NULL, false);
    end.setString(req.getDateTimeRange().getEnd(), NULL, false);
...
bool Cws_machineEx::onGetGlobalMetrics(IEspContext &context, IEspGetGlobalMetricsRequest &req, IEspGetGlobalMetricsResponse &resp)
{
    try
    {
        context.ensureFeatureAccess(FEATURE_URL, SecAccess_Read, ECLWATCH_MACHINE_INFO_ACCESS_DENIED, "Failed to get global metrics. Permission denied.");
...
static unsigned wsMachineDaliInitCounter = 0;
static Owned<IUserDescriptor> wsMachineUser;

static void daliClientInit()
{
    if (wsMachineDaliInitCounter != 0)
        return;
    InitModuleObjects();
    wsMachineUser.setown(createUserDescriptor());
    wsMachineUser->set("user", "passwd");
    SocketEndpoint ep;
    ...
    wsMachineDaliInitCounter++;
}

static void daliClientEnd()
{
    if (!wsMachineDaliInitCounter)
        return;
    else if (wsMachineDaliInitCounter == 1)
    {
        releaseAtoms();
        closedownClientProcess();
        setNodeCaching(false);
        wsMachineUser.clear();
        wsMachineDaliInitCounter = 0;
    }
    else
        wsMachineDaliInitCounter--;
}
...
class DaliWsMachineGlobalMetricsTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(DaliWsMachineGlobalMetricsTest);
        CPPUNIT_TEST(setUp);
...
public:
    ...
    {
        // Use generated serializer from ws_machine.esp for canonical XML
        ...
        CGetGlobalMetricsResponse::serializer(nullptr, *impl, out, true); // keep root tag
    }
    ...
    {
        static const char * requestXML =
            "<GetGlobalMetricsRequest>"
              "<Category>All</Category>"
              "<DateTimeRange><Start>1999-01-01T00:00:00</Start><End>2099-01-01T00:00:00</End></DateTimeRange>"
            "</GetGlobalMetricsRequest>";
    ...
    void testSingleCategoryAndDimensions()
    {
        static const char * requestXML =
            "<GetGlobalMetricsRequest>"
              ...
              "<Dimensions>"
                "<Dimension><Name>user</Name><Value>bob</Value></Dimension>"
              "</Dimensions>"
              "<DateTimeRange><Start>1999-01-01T00:00:00</Start><End>2099-01-01T00:00:00</End></DateTimeRange>"
            "</GetGlobalMetricsRequest>";
        Owned<IEspGetGlobalMetricsRequest> req = createRequestFromXML(requestXML);
        ...
        static const char * expected =
            "<GetGlobalMetricsResponse><GlobalMetrics>"
                "<GlobalMetric><Category>categoryOne</Category><Dimensions><Dimension><Name>user</Name><Value>bob</Value></Dimension><Dimension><Name>cluster</Name><Value>thor1</Value></Dimension></Dimensions><DateTimeRange><Start>1999070112</Start><End>1999070112</End></DateTimeRange><Stats><Stat><Name>TimeLocalExecute</Name><Value>333</Value></Stat></Stats></GlobalMetric>"
            "</GlobalMetrics></GetGlobalMetricsResponse>";
...
CPPUNIT_TEST_SUITE_REGISTRATION(DaliWsMachineGlobalMetricsTest);
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(DaliWsMachineGlobalMetricsTest, "DaliWsMachineGlobalMetricsTest");
#endif // _USE_CPPUNIT

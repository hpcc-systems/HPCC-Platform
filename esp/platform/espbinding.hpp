...
public:
    ...
    IPropertyTree *getNavFolder(IPropertyTree &root, const char *name);
    ...
    IPropertyTree *updateNavLink(IPropertyTree &folder, const char *name, const char *path, const char *tooltip, const char *menu=NULL, const char *navPath=NULL);

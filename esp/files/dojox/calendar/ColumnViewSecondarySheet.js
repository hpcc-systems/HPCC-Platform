...
define("dojox/calendar/ColumnViewSecondarySheet",["./MatrixView","dojo/text!./templates/ColumnViewSecondarySheet.html","dojo/_base/html","dojo/_base/declare","dojo/_base/event","dojo/_base/lang","dojo/_base/sniff","dojo/dom","dojo/dom-class","dojo/dom-geometry","dojo/dom-construct","dojo/date","dojo/date/locale","dojo/query","dojox/html/metrics","dojo/_base/fx","dojo/on","dojo/window"],function(_1,_2,_3,_4,_5,_6,_7,_8,_9,_a,_b,_c,_d,_e,_f,fx,on,win){
return _4("dojox.calendar.ColumnViewSecondarySheet",_1,{templateString:_2,rowCount:1,cellPaddingTop:4,roundToDay:false,_defaultHeight:-1,layoutDuringResize:true,_defaultItemToRendererKindFunc:function(_10){
return _10.allDay?"horizontal":null;
...
e.source=this;
return e;
},_dispatchCalendarEvt:function(e,_11){
e=this.inherited(arguments);
if(this.owner.owner){
this.owner.owner[_11](e);
}
},_layoutExpandRenderers:function(_12,_13,_14){
...
},expandRendererClickHandler:function(e,_15){
_5.stop(e);
var h=_a.getMarginBox(this.domNode).h;
if(this._defaultHeight==h||h<this._getExpandedHeight()){
this._expandedRowCol=_15.columnIndex;

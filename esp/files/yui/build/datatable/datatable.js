...
(function() {
    ...
    */
    ...
    /**
    * The PasswordCellEditor class provides functionality for inline editing
    * DataTable cell data with an INPUT TYPE=PASSWORD element.
    *
    * @namespace YAHOO.widget
    ...
    */
    widget.PasswordCellEditor = function(oConfigs) {
        this._sId = "yui-textboxceditor" + YAHOO.widget.BaseCellEditor._nCount++;
        widget.PasswordCellEditor.superclass.constructor.call(this, "password", oConfigs);
    };

    // PasswordCellEditor extends BaseCellEditor
    lang.extend(widget.PasswordCellEditor, BCE, {

        /////////////////////////////////////////////////////////////////////////////
        //
        // PasswordCellEditor public properties
        //
        /////////////////////////////////////////////////////////////////////////////
        /**
        * Reference to the textbox element.
        ...
        */
        ...
        /////////////////////////////////////////////////////////////////////////////
        //
        // PasswordCellEditor public methods
        //
        /////////////////////////////////////////////////////////////////////////////
    ...
    */
    renderForm: function() {
      ...
      if (ua.webkit > 420) {
        try {
          elTextbox = this.getContainerEl().appendChild(document.createElement("form")).appendChild(document.createElement("<input type=\"password\" />"));
        }
        catch (e) {
          elTextbox = this.getContainerEl().appendChild(document.createElement("form")).appendChild(document.createElement("input"));
          elTextbox.type = "password";
        }
      }
      else {
        try {
          elTextbox = this.getContainerEl().appendChild(document.createElement("<input type=\"password\" />"));
        }
        catch (e) {
          elTextbox = this.getContainerEl().appendChild(document.createElement("input"));
          elTextbox.type = "password";
      ...
      this.textbox = elTextbox;
        ...
        /**
        * Moves PasswordCellEditor UI to a cell.
        *
        * @method move
        */
        move: function() {
        ...
        /**
        * Resets PasswordCellEditor UI to initial state.
        *
        * @method resetForm
        */
        resetForm: function() {
        ...
        /**
        * Sets focus in PasswordCellEditor.
        *
        * @method focus
        */
        focus: function() {
        ...
        /**
        * Returns new value for PasswordCellEditor.
        *
        * @method getInputValue
        */
        getInputValue: function() {
    ...
    lang.augmentObject(widget.PasswordCellEditor, BCE);
    ...
    */
    DT.Editors = {
        ...
        password: widget.PasswordCellEditor
    };

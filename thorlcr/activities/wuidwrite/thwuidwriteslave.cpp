...
public:
    ...
    virtual void process() override
    {
        ...
        ::ActPrintLog(this, TraceFlags::Detailed, "WORKUNITWRITE: processing first block");
...
public:
    ...
    virtual void process() override
    {
        ...
        ::ActPrintLog(this, TraceFlags::Detailed, "WORKUNITWRITELOCAL: processing first block");

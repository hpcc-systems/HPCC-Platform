...
public:
    ...
    CMultiCoreJoinHelperBase(CActivityBase &_activity, unsigned numthreads, IJoinHelper *_jhelper, IHThorJoinArg *_helper, IRowInterfaces *_rowIf)
...
public:
    ...
    CMultiCoreJoinHelper(CActivityBase &activity, unsigned numthreads, IJoinHelper *_jhelper, IHThorJoinArg *_helper, IRowInterfaces *_rowIf)
...
public:
    ...
    CMultiCoreUnorderedJoinHelper(CActivityBase &activity, unsigned numthreads, IJoinHelper *_jhelper, IHThorJoinArg *_helper, IRowInterfaces *_rowIf)
        : CMultiCoreJoinHelperBase(activity, numthreads, _jhelper, _helper, _rowIf)
    {
        reader.parent = this;
...
IJoinHelper *createJoinHelper(CActivityBase &activity, IHThorJoinArg *helper, IRowInterfaces *rowIf, bool parallelmatch, bool unsortedoutput)
{
    ...
    if (unsortedoutput)
        return new CMultiCoreUnorderedJoinHelper(activity, numthreads, jhelper, helper, rowIf);
    return new CMultiCoreJoinHelper(activity, numthreads, jhelper, helper, rowIf);
}

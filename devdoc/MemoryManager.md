...
Roxie uses a separate instance of IRowManager for each query. This
...
Some of the memory allocations cover more than one \"page\" - e.g.,
...
When OS processes use a large amount of memory, mapping virtual

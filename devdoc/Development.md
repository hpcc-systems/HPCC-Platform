...
**Note:** Auto-update should be disabled in CI environments to avoid concurrency issues. Always verify vcpkg-configuration.json changes in pull requests for security.

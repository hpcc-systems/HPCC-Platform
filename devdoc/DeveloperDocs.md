...
For more details, refer to the [Dali Documentation](DaliDocumentation).

## Sasha

Guidelines for handling the Sasha server, including maintenance and configuration.

[Sasha Readme](/dali/sasha/sasha)
...
For more details, refer to the [DFU Documentation](TBD).
...
For more details, refer to the [DFUPlus Documentation](TBD).
...
The Code Generator is a powerful tool within the HPCC Platform that automates the creation of C++ code from ECL Code, reducing development time and minimizing errors. Key aspects of the Code Generator: [Code Generator](CodeGenerator)
...
For more details about the CLI, refer to the [ESDL Command Line Tool](../tools/esdlcmd/README)

## Security

* [Security User Authentication](SecurityUserAuthentication)
* [Security Configuration](SecurityConfig.md)

### LDAP

Steps for configuring and managing LDAP for authentication and authorization. [LDAP Security](LDAPSecurityManager)

### Secrets

Best practices for managing secrets securely within the system.

* [Kubernetes Secrets](../helm/examples/secrets/README-kubernetessecrets)

* [Vault Secrets K8s Authentication](../helm/examples/secrets/README-vault_secrets_using_kubernetes_authentication)

* [Vault Secrets Approle Authentication](../helm/examples/secrets/README-vaultsecretsusingapprolevaultauthentication)

* [Vault Secrets Client Cert Vault Authentication](../helm/examples/secrets/README-vaultsecretsusingclientcertvaultauthentication)
...
For more details, refer to the [Thor Engine Documentation](TBD).
...
For more details, refer to the [Roxie Documentation](roxie).
...
For more details, you can refer to the linked Metrics Framework Design in your documentation. [Metrics Framework Design](Metrics)
...
For more details, refer to the [Regression Suite Documentation](..\testing\regress\regress).

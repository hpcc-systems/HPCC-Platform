...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if (WIN32)
    option(USE_APR "Use Apache Portable Runtime" OFF)
  else()
    option(USE_APR "Use Apache Portable Runtime" ON)
  endif()
      ...
      if(USE_APR)
        ...
        if (APR_FOUND)
          ...
          if (NOT APRUTIL_FOUND)
            message(FATAL_ERROR "APRUTIL is needed by APR but was not found")
          endif()
        else()

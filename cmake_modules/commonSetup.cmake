...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  option(STRIP_RELEASE_SYMBOLS "Strip symbols from release builds" ON)
  ...
  IF ( NOT MAKE_DOCS_ONLY )
      ...
      if(USE_CBLAS)
        if (VCPKG_APPLOCAL_DEPS)
          ...
          set(CBLAS_FOUND OpenBLAS_FOUND)
          set(CBLAS_INCLUDE_DIR OpenBLAS_DIR)
          set(CBLAS_LIBRARIES OpenBLAS::OpenBLAS)
        else ()
          find_package(CBLAS)
        endif()
        if(CBLAS_FOUND)

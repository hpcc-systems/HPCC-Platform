...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if ( USE_XALAN AND USE_LIBXSLT )
      ...
      set(USE_XERCES OFF)
      set(USE_XALAN OFF)
  elseif( NOT USE_XALAN AND NOT USE_LIBXSLT )
      set(USE_XALAN ON)
      set(USE_XERCES ON)
      set(USE_LIBXSLT OFF)
      set(USE_LIBXML2 OFF)
  elseif ( USE_XALAN AND NOT USE_LIBXSLT )
      set(USE_XERCES ON)
      set(USE_LIBXSLT OFF)
      set(USE_LIBXML2 OFF)
  elseif ( USE_LIBXSLT AND NOT USE_XALAN )
      set(USE_LIBXML2 ON)
      set(USE_XERCES OFF)
      set(USE_XALAN OFF)
  endif()
  ...
  if(USE_XALAN)
    ...
    if (XALAN_FOUND)
      ...
      set(USE_XSLT_LIB "XALAN")
      set(XSLT_INCLUDE_DIR ${XALAN_INCLUDE_DIR})
      set(XSLT_LIBRARIES ${XALAN_LIBRARIES})
      set(XSLT_PROCESSOR_SOURCE "xalan_processor.cpp")
    else()
  ...
  if(USE_LIBXSLT)  
    ...
    if (LIBXSLT_FOUND)
      ...
      set(USE_XSLT_LIB "LIBXSLT")
      set(XSLT_INCLUDE_DIR ${LIBXSLT_INCLUDE_DIR} ${LIBEXSLT_INCLUDE_DIR})
      set(XSLT_LIBRARIES ${LIBXSLT_LIBRARIES} ${LIBEXLST_LIBRARIES})
      set(XSLT_PROCESSOR_SOURCE "libxslt_processor.cpp")
    else()
  ...
  if(USE_XERCES)
    ...
    if (XERCES_FOUND)
      ...
      set(USE_XML_LIB "XERCES")
      set(XML_INCLUDE_DIR ${XERCES_INCLUDE_DIR})
      set(XML_LIBRARIES ${XERCES_LIBRARIES})
    else()

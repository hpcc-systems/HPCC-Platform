...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if (USE_PROTRACE)
    ...
    if (PROTRACE_TASK_SIZES)
      add_definitions(-DPROTRACE_TASK_SIZES)
    endif()
    if (PROTRACE_DETAILED)
      add_definitions(-DPROTRACE_DETAILED)
    endif()
      ...
      IF (USE_CPPUNIT)
        ...
        IF (CppUnit_FOUND)
          if (CppUnit_LIBRARY_DEBUG AND CppUnit_LIBRARY_RELEASE)
            set(CppUnit_LIBRARIES debug ${CppUnit_LIBRARY_DEBUG} optimized ${CppUnit_LIBRARY_RELEASE})
          ...
          elseif (CppUnit_LIBRARIES)
            list(REMOVE_DUPLICATES CppUnit_LIBRARIES)
          endif()

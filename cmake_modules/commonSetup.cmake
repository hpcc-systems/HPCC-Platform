        ...
        IF (WIN32)
          IF (VCPKG_INSTALLED_DIR)
            IF("${CMAKE_GENERATOR_PLATFORM}" STREQUAL "x64")
              SET(bisoncmd "${CMAKE_SOURCE_DIR}/vcpkg/installed/x64-windows/tools/winflexbison/win_bison.exe")
              SET(flexcmd "${CMAKE_SOURCE_DIR}/vcpkg/installed/x64-windows/tools/winflexbison/win_flex.exe")
            ELSE()
              SET(bisoncmd "${CMAKE_SOURCE_DIR}/vcpkg/installed/x86-windows/tools/winflexbison/win_bison.exe")
              SET(flexcmd "${CMAKE_SOURCE_DIR}/vcpkg/installed/x86-windows/tools/winflexbison/win_flex.exe")
            ENDIF()
          ELSE()

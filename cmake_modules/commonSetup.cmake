...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if (WIN32)
    ...
    # Enforce strict standard conformance in MSVC (disables permissive mode)
    if (MSVC)
      # Avoid adding multiple times if file reprocessed
      if (NOT CMAKE_CXX_FLAGS MATCHES "/permissive-")

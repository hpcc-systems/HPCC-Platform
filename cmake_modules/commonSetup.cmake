...
#########################################################
  ...
  IF ( NOT MAKE_DOCS_ONLY )
      IF (USE_OPENLDAP)
        FIND_PATH (OPENLDAP_INCLUDE_DIR NAMES "ldap.h")
        FIND_LIBRARY (OPENLDAP_LIBRARY_LDAP NAMES "libldap.a")
        FIND_LIBRARY (OPENLDAP_LIBRARY_LBER NAMES "liblber.a")
        SET(OPENLDAP_LIBRARIES ${OPENLDAP_LIBRARY_LDAP} ${OPENLDAP_LIBRARY_LBER})
        set(OPENLDAP_FOUND ON)
        IF (OPENLDAP_FOUND)

...
if (NOT "${CMAKE_VERSION}" VERSION_LESS "2.8.7")
    if ( CMAKE_SYSTEM MATCHES Linux )
        ...
        if ( PLATFORM OR CLIENTTOOLS )
            ...
            set ( CPACK_DEBIAN_PACKAGE_DEPENDS "hpccsystems-platform (= ${CPACK_RPM_PACKAGE_RELEASE})")
            set ( CPACK_RPM_PACKAGE_REQUIRES "hpccsystems-platform = ${CPACK_RPM_PACKAGE_RELEASE}")
        endif()
    endif ( CMAKE_SYSTEM MATCHES Linux )
else()
...
if ( PLATFORM )
    ...
    install ( FILES ${CMAKE_BINARY_DIR}/HpccConfig.cmake_installed RENAME HpccConfig.cmake DESTINATION ${OSSDIR}/lib COMPONENT Include )
    install ( FILES ${CMAKE_BINARY_DIR}/HpccDepends.cmake DESTINATION ${OSSDIR}/lib COMPONENT Include )
    install ( FILES ${CMAKE_MODULE_PATH}/HpccUse.cmake DESTINATION ${OSSDIR}/lib COMPONENT Include )
endif()

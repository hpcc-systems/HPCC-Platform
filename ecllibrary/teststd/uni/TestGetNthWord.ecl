...
EXPORT TestGetNthWord := MODULE
  ...
  EXPORT TestConst := MODULE
    ...
    //Test 23 behaves differently from the string version, where the punctuation is included with the word returned
    EXPORT Test23 := ASSERT(Uni.GetNthWord(' ,,,, ',1)+'!' = '!');
    EXPORT Test24 := ASSERT(Uni.GetNthWord('List: abc, def, ghi,   jhi    ',0)+'!' = '!');
    //Tests 25, 26, and 27 behave differently from the string version, where the punctuation is included with the word returned
    ...
    //Test 28 behaves differently from the string version, where the punctuation is included with the word returned

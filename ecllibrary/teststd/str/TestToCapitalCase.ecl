...
EXPORT TestToCapitalCase := MODULE
  ...
  EXPORT TestConstant := MODULE
    ...
    //EXPORT Test13 := ASSERT(Str.ToCapitalCase('jähn mäcdonald')+'X' = 'Jähn MäcdonaldX', CONST);
    //EXPORT Test14 := ASSERT(Str.ToCapitalCase('ähn mäcdonald')+'X' = 'Ähn MäcdonaldX', CONST);
  END;

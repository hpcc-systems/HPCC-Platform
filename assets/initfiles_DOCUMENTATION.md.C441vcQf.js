...
</code></pre><h2 id="environment-variables" tabindex="-1">Environment Variables <a class="header-anchor" href="#environment-variables" aria-label="Permalink to &quot;Environment Variables&quot;">​</a></h2><p>The following environment variables can be set before running hpcc-init to control its behaviour.</p><table tabindex="0"><thead><tr><th>Variable</th><th>Default</th><th>Description</th></tr></thead><tbody><tr><td><code>HPCC_CONFIG</code></td><td><code>\${CONFIG_DIR}/environment.conf</code></td><td>Path to the HPCC environment config file</td></tr><tr><td><code>HPCC_XMLFILE</code></td><td><code>\${CONFIG_DIR}/environment.xml</code></td><td>Path to the HPCC environment XML file</td></tr><tr><td><code>HPCC_WAIT_TIME</code></td><td>120 (start), 30 (stop)</td><td>Override the number of seconds to wait when checking if a component has started or stopped. Dali defaults are 720 seconds for both start and stop; setting this variable overrides those defaults too.</td></tr></tbody></table><p>Example — use a 5-minute timeout when starting:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">HPCC_WAIT_TIME</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">300</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> /etc/init.d/hpcc-init</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> start</span></span></code></pre></div>`,27)])])}const m=t(a,[["render",o]]);export{u as __pageData,m as default};

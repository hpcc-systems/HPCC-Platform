...
protected:
    ...
    { 
        ...
        file.clear();
        file.setown(dfsdir->lookup(DFSUTSCOPE "::testfile1", UNKNOWN_USER, AccessMode::readLogicalMeta, false, false, nullptr, true));
        ...
        file.clear();
        file.setown(dfsdir->lookup(DFSUTSCOPE "::testfile2", UNKNOWN_USER, AccessMode::readLogicalMeta, false, false, nullptr, true));
        CPPUNIT_ASSERT(file.get()!=NULL);
        ...
        file.clear();
        file.setown(dfsdir->lookup(DFSUTSCOPE "::testfile3", UNKNOWN_USER, AccessMode::readLogicalMeta, false, false, nullptr, true));
        CPPUNIT_ASSERT(file.get()!=NULL);
        CPPUNIT_ASSERT(file->numParts()==8);
        for (pi=0;pi<8;pi++) {
        ...
        file.clear();
        file.setown(dfsdir->lookup(DFSUTSCOPE "::testfile4", UNKNOWN_USER, AccessMode::readLogicalMeta, false, false, nullptr, true));
        CPPUNIT_ASSERT(file.get()!=NULL);
        CPPUNIT_ASSERT(file->numParts()==8);
        for (pi=0;pi<8;pi++) {

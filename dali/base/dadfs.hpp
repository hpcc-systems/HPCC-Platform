...
interface IDistributedFileDirectory: extends IInterface
{
    ...
    virtual bool removeEntry(const char *name, IUserDescriptor *user, bool throwException, IDistributedFileTransaction *transaction=NULL, unsigned timeoutms=INFINITE) = 0;

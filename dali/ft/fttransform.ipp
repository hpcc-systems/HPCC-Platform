...
public:
    ...
    virtual unsigned __int64 getStatistic(StatisticKind kind) { return 0; /* TODO*/ }
...
public:
    ...
    virtual unsigned __int64 getStatistic(StatisticKind kind) { return input->getStatistic(kind); }

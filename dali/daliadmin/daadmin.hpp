...
extern DALIADMIN_API void dfsGroup(const char *name, const char *outputFilename, StringBuffer &out);
extern DALIADMIN_API int clusterGroup(const char *name, const char *outputFilename, StringBuffer &out);
...
extern DALIADMIN_API void dfsunlink(const char *lname, IUserDescriptor *user, StringBuffer &out);
extern DALIADMIN_API int dfsverify(const char *name, CDateTime *cutoff, IUserDescriptor *user, StringBuffer &out);
extern DALIADMIN_API int dfsperm(const char *obj, IUserDescriptor *user, StringBuffer &out);
...
extern DALIADMIN_API void cleanscopes(IUserDescriptor *user, StringBuffer &out);
extern DALIADMIN_API void normalizeFileNames(IUserDescriptor *user, const char *name, StringBuffer &out);
extern DALIADMIN_API void listmatches(const char *path, const char *match, const char *pval);
extern DALIADMIN_API void dfsreplication(const char *clusterMask, const char *lfnMask, unsigned redundancy, bool dryRun, StringBuffer &out);

...
class PrometheusMetricsReportContext : public MetricsReportContext
{
public:
...
public:
	...
	{
		PrometheusMetricsReportContext * reportContext = new PrometheusMetricsReportContext();
		doReport(std::string("prometheus"), reportContext);

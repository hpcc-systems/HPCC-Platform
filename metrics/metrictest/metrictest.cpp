...
Global level:
 ...
 It can, however, be expanded by adding an addition sink
  ...
  metrics:
    ...
    -                       # one each for each sink defined
...
int main(int argc, char *argv[])
{
    ...
    //IPropertyTree *yamlFlow = createPTreeFromYAMLString(configYml, ipt_none, ptr_ignoreWhiteSpace, nullptr);
    IPropertyTree *pSettings;
    ...
    if (argc > 1)
    {
        ...
        pSinkSettings->setProp("@filename", "/home/ken/filestats.txt");
    }
    else
    {
    ...
    IPropertyTree *pTriggerSettings = nullptr;

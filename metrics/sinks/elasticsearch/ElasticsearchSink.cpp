...
{
    IMetricSink *pSink = new ElasticsearchSink(name, pSettingsTree);
    return pSink;
}
...
void ElasticsearchSink::handle(const MeasurementVector &values, const std::shared_ptr<IMetricSet> &pMetricSet, MetricsReportContext *pContext)
{
